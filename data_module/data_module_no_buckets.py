...
class Data_Module:
    def __init__(self, val_path="../valgrind_output/", token_path="../tokenized_sources_limited_tokens/", test_percent=0.2, valid_percent=0.1, type_of_data="data.no.bucket", max_tokens=200):
    ...
    def generic_iterator(self, all_examples, batch_size):
        ...
        for i in range(length):
            ...
            if (i % batch_size) == (batch_size - 1):
                results_matrix = np.array(results_array, dtype=float)
    ...
    def valid_iterator(self, num_examples):
        return self.generic_iterator(self.valid_examples, num_examples)
...
def main():
    ...
    for data,results in d.train_iterator(10):
        print "data",data
        print "res",results
