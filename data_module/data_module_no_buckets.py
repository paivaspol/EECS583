...
class Data_Module:
    def __init__(self, val_path="../valgrind_output/", token_path="../tokenized_sources_limited_tokens/", test_percent=0.3, type_of_data="data.no.bucket.results", max_tokens=200):
