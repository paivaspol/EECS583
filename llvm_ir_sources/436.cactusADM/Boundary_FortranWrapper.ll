; ModuleID = '../../SPEC/benchspec/CPU2006/436.cactusADM/src/CactusBindings/Boundary_FortranWrapper.c'
...
entry:
  ...
  %0 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dx, align 4, !dbg !67, !tbaa !68
...
if.then:                                          ; preds = %entry
  ...
  store i32 %call, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dx, align 4, !dbg !67, !tbaa !68
  br label %if.end, !dbg !67

if.end:                                           ; preds = %if.then, %entry
  %1 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKGROUPNUM_gridspacings, align 4, !dbg !67, !tbaa !68
...
if.then2:                                         ; preds = %if.end
  ...
  store i32 %call3, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKGROUPNUM_gridspacings, align 4, !dbg !67, !tbaa !68
  br label %if.end4, !dbg !67

if.end4:                                          ; preds = %if.then2, %if.end
  %2 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dy, align 4, !dbg !67, !tbaa !68
...
if.then6:                                         ; preds = %if.end4
  ...
  store i32 %call7, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dy, align 4, !dbg !67, !tbaa !68
  br label %if.end8, !dbg !67

if.end8:                                          ; preds = %if.then6, %if.end4
  %3 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dz, align 4, !dbg !67, !tbaa !68
...
if.then10:                                        ; preds = %if.end8
  ...
  store i32 %call11, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dz, align 4, !dbg !67, !tbaa !68
  br label %if.end12, !dbg !67

if.end12:                                         ; preds = %if.then10, %if.end8
  %4 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_r, align 4, !dbg !67, !tbaa !68
...
if.then14:                                        ; preds = %if.end12
  ...
  store i32 %call15, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_r, align 4, !dbg !67, !tbaa !68
  br label %if.end16, !dbg !67

if.end16:                                         ; preds = %if.then14, %if.end12
  %5 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKGROUPNUM_coordinates, align 4, !dbg !67, !tbaa !68
...
if.then18:                                        ; preds = %if.end16
  ...
  store i32 %call19, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKGROUPNUM_coordinates, align 4, !dbg !67, !tbaa !68
  br label %if.end20, !dbg !67

if.end20:                                         ; preds = %if.then18, %if.end16
  %6 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_x, align 4, !dbg !67, !tbaa !68
...
if.then22:                                        ; preds = %if.end20
  ...
  store i32 %call23, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_x, align 4, !dbg !67, !tbaa !68
  br label %if.end24, !dbg !67

if.end24:                                         ; preds = %if.then22, %if.end20
  %7 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_y, align 4, !dbg !67, !tbaa !68
...
if.then26:                                        ; preds = %if.end24
  ...
  store i32 %call27, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_y, align 4, !dbg !67, !tbaa !68
  br label %if.end28, !dbg !67

if.end28:                                         ; preds = %if.then26, %if.end24
  %8 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_z, align 4, !dbg !67, !tbaa !68
...
if.then30:                                        ; preds = %if.end28
  ...
  store i32 %call31, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_z, align 4, !dbg !67, !tbaa !68
...
if.end32:                                         ; preds = %if.end28, %if.then30
  ...
  %22 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKGROUPNUM_coordinates, align 4, !dbg !72, !tbaa !68
...
cond.end38:                                       ; preds = %cond.false, %cond.true35
  ...
  %.pr = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKGROUPNUM_coordinates, align 4, !dbg !72, !tbaa !68
...
cond.end50:                                       ; preds = %cond.false42, %cond.true45
  ...
  %.pr162.pr = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKGROUPNUM_coordinates, align 4, !dbg !72, !tbaa !68
...
cond.end62:                                       ; preds = %cond.false54, %cond.end50, %cond.end38, %if.end32, %cond.true57
  ...
  %23 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dx, align 4, !dbg !72, !tbaa !68
...
cond.end68:                                       ; preds = %cond.end62, %cond.false66
  ...
  %27 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dy, align 4, !dbg !72, !tbaa !68
...
cond.end77:                                       ; preds = %cond.end68, %cond.false72
  ...
  %31 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dz, align 4, !dbg !72, !tbaa !68
...
cond.end86:                                       ; preds = %cond.end77, %cond.false81
  ...
  %35 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_r, align 4, !dbg !72, !tbaa !68
...
cond.end95:                                       ; preds = %cond.end86, %cond.false90
  ...
  %39 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_x, align 4, !dbg !72, !tbaa !68
...
cond.end104:                                      ; preds = %cond.end95, %cond.false99
  ...
  %43 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_y, align 4, !dbg !72, !tbaa !68
...
cond.end113:                                      ; preds = %cond.end104, %cond.false108
  ...
  %47 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_z, align 4, !dbg !72, !tbaa !68
...
!0 = metadata !{i32 786449, metadata !1, i32 12, metadata !"clang version 3.3 (tags/RELEASE_33/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !56, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/CactusBindings/Boundary_FortranWrapper.c] [DW_LANG_C99]
!1 = metadata !{metadata !"../../SPEC/benchspec/CPU2006/436.cactusADM/src/CactusBindings/Boundary_FortranWrapper.c", metadata !"/home/arquinn/Project1/EECS583/source_extraction_scripts"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"CCTKi_BindingsFortranWrapperBoundary", metadata !"CCTKi_BindingsFortranWrapperBoundary", metadata !"", i32 13, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, i32 (%struct.cGH*, i8*)* @CCTKi_BindingsFortranWrapperBoundary, null, null, metadata !47, i32 14} ; [ DW_TAG_subprogram ] [line 13] [def] [scope 14] [CCTKi_BindingsFortranWrapperBoundary]
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/CactusBindings/Boundary_FortranWrapper.c]
...
!57 = metadata !{i32 786484, i32 0, metadata !4, metadata !"CCTKARGNUM_coarse_dx", metadata !"CCTKARGNUM_coarse_dx", metadata !"", metadata !5, i32 17, metadata !8, i32 1, i32 1, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dx, null} ; [ DW_TAG_variable ] [CCTKARGNUM_coarse_dx] [line 17] [local] [def]
!58 = metadata !{i32 786484, i32 0, metadata !4, metadata !"CCTKGROUPNUM_gridspacings", metadata !"CCTKGROUPNUM_gridspacings", metadata !"", metadata !5, i32 17, metadata !8, i32 1, i32 1, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKGROUPNUM_gridspacings, null} ; [ DW_TAG_variable ] [CCTKGROUPNUM_gridspacings] [line 17] [local] [def]
!59 = metadata !{i32 786484, i32 0, metadata !4, metadata !"CCTKARGNUM_coarse_dy", metadata !"CCTKARGNUM_coarse_dy", metadata !"", metadata !5, i32 17, metadata !8, i32 1, i32 1, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dy, null} ; [ DW_TAG_variable ] [CCTKARGNUM_coarse_dy] [line 17] [local] [def]
!60 = metadata !{i32 786484, i32 0, metadata !4, metadata !"CCTKARGNUM_coarse_dz", metadata !"CCTKARGNUM_coarse_dz", metadata !"", metadata !5, i32 17, metadata !8, i32 1, i32 1, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dz, null} ; [ DW_TAG_variable ] [CCTKARGNUM_coarse_dz] [line 17] [local] [def]
!61 = metadata !{i32 786484, i32 0, metadata !4, metadata !"CCTKARGNUM_r", metadata !"CCTKARGNUM_r", metadata !"", metadata !5, i32 17, metadata !8, i32 1, i32 1, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_r, null} ; [ DW_TAG_variable ] [CCTKARGNUM_r] [line 17] [local] [def]
!62 = metadata !{i32 786484, i32 0, metadata !4, metadata !"CCTKGROUPNUM_coordinates", metadata !"CCTKGROUPNUM_coordinates", metadata !"", metadata !5, i32 17, metadata !8, i32 1, i32 1, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKGROUPNUM_coordinates, null} ; [ DW_TAG_variable ] [CCTKGROUPNUM_coordinates] [line 17] [local] [def]
!63 = metadata !{i32 786484, i32 0, metadata !4, metadata !"CCTKARGNUM_x", metadata !"CCTKARGNUM_x", metadata !"", metadata !5, i32 17, metadata !8, i32 1, i32 1, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_x, null} ; [ DW_TAG_variable ] [CCTKARGNUM_x] [line 17] [local] [def]
!64 = metadata !{i32 786484, i32 0, metadata !4, metadata !"CCTKARGNUM_y", metadata !"CCTKARGNUM_y", metadata !"", metadata !5, i32 17, metadata !8, i32 1, i32 1, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_y, null} ; [ DW_TAG_variable ] [CCTKARGNUM_y] [line 17] [local] [def]
!65 = metadata !{i32 786484, i32 0, metadata !4, metadata !"CCTKARGNUM_z", metadata !"CCTKARGNUM_z", metadata !"", metadata !5, i32 17, metadata !8, i32 1, i32 1, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_z, null} ; [ DW_TAG_variable ] [CCTKARGNUM_z] [line 17] [local] [def]
