...
define i32 @CCTKi_BindingsFortranWrapperBoundary(%struct.cGH* %GH, i8* nocapture %fpointer) #0 {
  %1 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dx, align 4, !tbaa !2
  %2 = icmp eq i32 %1, -1
  br i1 %2, label %3, label %5

; <label>:3                                       ; preds = %0
  %4 = tail call i32 @CCTK_VarIndex(i8* getelementptr inbounds ([16 x i8]* @.str, i64 0, i64 0)) #2
  store i32 %4, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dx, align 4, !tbaa !2
  br label %5

; <label>:5                                       ; preds = %3, %0
  %6 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKGROUPNUM_gridspacings, align 4, !tbaa !2
  %7 = icmp eq i32 %6, -1
  br i1 %7, label %8, label %10

; <label>:8                                       ; preds = %5
  %9 = tail call i32 @CCTK_GroupIndex(i8* getelementptr inbounds ([19 x i8]* @.str1, i64 0, i64 0)) #2
  store i32 %9, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKGROUPNUM_gridspacings, align 4, !tbaa !2
  br label %10

; <label>:10                                      ; preds = %8, %5
  %11 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dy, align 4, !tbaa !2
  %12 = icmp eq i32 %11, -1
  br i1 %12, label %13, label %15

; <label>:13                                      ; preds = %10
  %14 = tail call i32 @CCTK_VarIndex(i8* getelementptr inbounds ([16 x i8]* @.str2, i64 0, i64 0)) #2
  store i32 %14, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dy, align 4, !tbaa !2
  br label %15

; <label>:15                                      ; preds = %13, %10
  %16 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dz, align 4, !tbaa !2
  %17 = icmp eq i32 %16, -1
  br i1 %17, label %18, label %20

; <label>:18                                      ; preds = %15
  %19 = tail call i32 @CCTK_VarIndex(i8* getelementptr inbounds ([16 x i8]* @.str3, i64 0, i64 0)) #2
  store i32 %19, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dz, align 4, !tbaa !2
  br label %20

; <label>:20                                      ; preds = %18, %15
  %21 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_r, align 4, !tbaa !2
  %22 = icmp eq i32 %21, -1
  br i1 %22, label %23, label %25

; <label>:23                                      ; preds = %20
  %24 = tail call i32 @CCTK_VarIndex(i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0)) #2
  store i32 %24, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_r, align 4, !tbaa !2
  br label %25

; <label>:25                                      ; preds = %23, %20
  %26 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKGROUPNUM_coordinates, align 4, !tbaa !2
  %27 = icmp eq i32 %26, -1
  br i1 %27, label %28, label %30

; <label>:28                                      ; preds = %25
  %29 = tail call i32 @CCTK_GroupIndex(i8* getelementptr inbounds ([18 x i8]* @.str5, i64 0, i64 0)) #2
  store i32 %29, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKGROUPNUM_coordinates, align 4, !tbaa !2
  br label %30

; <label>:30                                      ; preds = %28, %25
  %31 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_x, align 4, !tbaa !2
  %32 = icmp eq i32 %31, -1
  br i1 %32, label %33, label %35

; <label>:33                                      ; preds = %30
  %34 = tail call i32 @CCTK_VarIndex(i8* getelementptr inbounds ([8 x i8]* @.str6, i64 0, i64 0)) #2
  store i32 %34, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_x, align 4, !tbaa !2
  br label %35

; <label>:35                                      ; preds = %33, %30
  %36 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_y, align 4, !tbaa !2
  %37 = icmp eq i32 %36, -1
  br i1 %37, label %38, label %40

; <label>:38                                      ; preds = %35
  %39 = tail call i32 @CCTK_VarIndex(i8* getelementptr inbounds ([8 x i8]* @.str7, i64 0, i64 0)) #2
  store i32 %39, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_y, align 4, !tbaa !2
  br label %40

; <label>:40                                      ; preds = %38, %35
  %41 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_z, align 4, !tbaa !2
  %42 = icmp eq i32 %41, -1
  br i1 %42, label %43, label %45

; <label>:43                                      ; preds = %40
  %44 = tail call i32 @CCTK_VarIndex(i8* getelementptr inbounds ([8 x i8]* @.str8, i64 0, i64 0)) #2
  store i32 %44, i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_z, align 4, !tbaa !2
  br label %45
...
; <label>:45                                      ; preds = %43, %40
  ...
  %76 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKGROUPNUM_coordinates, align 4, !tbaa !2
...
; <label>:83                                      ; preds = %78, %81
  ...
  %.pr = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKGROUPNUM_coordinates, align 4, !tbaa !2
...
.thread:                                          ; preds = %85, %88
  ...
  %.pr3.pr = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKGROUPNUM_coordinates, align 4, !tbaa !2
...
.thread4:                                         ; preds = %45, %83, %91, %94, %.thread
  ...
  %99 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dx, align 4, !tbaa !2
...
; <label>:109                                     ; preds = %.thread4, %101
  ...
  %111 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dy, align 4, !tbaa !2
...
; <label>:121                                     ; preds = %109, %113
  ...
  %123 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_coarse_dz, align 4, !tbaa !2
...
; <label>:133                                     ; preds = %121, %125
  ...
  %135 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_r, align 4, !tbaa !2
...
; <label>:145                                     ; preds = %133, %137
  ...
  %147 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_x, align 4, !tbaa !2
...
; <label>:157                                     ; preds = %145, %149
  ...
  %159 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_y, align 4, !tbaa !2
...
; <label>:169                                     ; preds = %157, %161
  ...
  %171 = load i32* @CCTKi_BindingsFortranWrapperBoundary.CCTKARGNUM_z, align 4, !tbaa !2
