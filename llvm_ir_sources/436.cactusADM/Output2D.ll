; ModuleID = '../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c'
...
@.str1 = private unnamed_addr constant [66 x i8] c"../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c\00", align 1
...
@.str3 = private unnamed_addr constant [45 x i8] c"No IOASCII 2D output for '%s' (dim != [2,3])\00", align 1
@.str4 = private unnamed_addr constant [61 x i8] c"No IOASCII 2D output for '%s' (not a grid function or array)\00", align 1
...
@.str7 = private unnamed_addr constant [39 x i8] c"IOASCII_2D: Output every %d iterations\00", align 1
@.str8 = private unnamed_addr constant [11 x i8] c"out2D_vars\00", align 1
@.str9 = private unnamed_addr constant [36 x i8] c"IOASCII_2D: Output requested for %s\00", align 1
...
@.str12 = private unnamed_addr constant [56 x i8] c"$Id: Output2D.c,v 1.12 2001/12/28 21:22:44 tradke Exp $\00", align 1

; Function Attrs: nounwind optsize readnone uwtable
define i8* @CCTKi_version_CactusBase_IOASCII_Output2D_c() #0 {
entry:
  ret i8* getelementptr inbounds ([56 x i8]* @.str12, i64 0, i64 0), !dbg !226
}
...
entry:
  ...
  %out2D_every = getelementptr inbounds i8* %call, i64 4, !dbg !230
  %1 = bitcast i8* %out2D_every to i32*, !dbg !230
...
for.body.lr.ph:                                   ; preds = %for.cond.preheader
  ...
  %out2D_last = getelementptr inbounds i8* %call, i64 72, !dbg !236
  %3 = bitcast i8* %out2D_last to i32**, !dbg !236
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %call4 = tail call i32 @IOASCII_TimeFor2D(%struct.cGH* %GH, i32 %4) #7, !dbg !239
...
if.end6:                                          ; preds = %for.body
  ...
  %call8 = tail call i32 @IOASCII_Write2D(%struct.cGH* %GH, i32 %4, i8* %call7) #6, !dbg !241
...
entry:
  ...
  %0 = load i8** getelementptr inbounds (%struct.anon* @ioasciipriv_, i64 0, i32 12), align 8, !dbg !248, !tbaa !242
  call void @llvm.dbg.value(metadata !{i8* %0}, i64 0, metadata !164), !dbg !248
  %1 = load i32* getelementptr inbounds (%struct.anon* @ioasciipriv_, i64 0, i32 31), align 4, !dbg !248, !tbaa !231
  call void @llvm.dbg.value(metadata !{i32 %1}, i64 0, metadata !184), !dbg !248
  ...
  %out2D_every1 = getelementptr inbounds %struct.IOASCIIGH* %myGH, i64 0, i32 1, !dbg !249
  %4 = load i32* %out2D_every1, align 4, !dbg !249, !tbaa !231
  ...
  store i32 %.cond, i32* %out2D_every1, align 4, !dbg !250, !tbaa !231
...
if.then10:                                        ; preds = %lor.lhs.false, %if.then7
  %5 = load i32* %out2D_every1, align 4, !dbg !256, !tbaa !231
...
if.end14:                                         ; preds = %lor.lhs.false, %entry, %if.then10
  ...
  %6 = load i32* @CheckSteerableParameters.out2D_vars_lastset, align 4, !dbg !260, !tbaa !231
...
if.then17:                                        ; preds = %if.end14
  ...
  %do_out2D = getelementptr inbounds %struct.IOASCIIGH* %myGH, i64 0, i32 4, !dbg !263
  %7 = load i8** %do_out2D, align 8, !dbg !263, !tbaa !242
  %conv = sext i32 %call18 to i64, !dbg !263
  call void @llvm.memset.p0i8.i64(i8* %7, i8 0, i64 %conv, i32 1, i1 false), !dbg !263
  %8 = load i8** %do_out2D, align 8, !dbg !264, !tbaa !242
...
for.body:                                         ; preds = %for.inc, %if.then26
  ...
  %9 = load i8** %do_out2D, align 8, !dbg !272, !tbaa !242
...
if.end43:                                         ; preds = %if.then26, %for.end, %lor.lhs.false23, %if.then40
  store i32 %call15, i32* @CheckSteerableParameters.out2D_vars_lastset, align 4, !dbg !289, !tbaa !231
...
entry:
  ...
  %out2D_every = getelementptr inbounds i8* %call, i64 4, !dbg !297
  %1 = bitcast i8* %out2D_every to i32*, !dbg !297
...
if.end:                                           ; preds = %entry
  ...
  %do_out2D = getelementptr inbounds i8* %call, i64 24, !dbg !298
  %3 = bitcast i8* %do_out2D to i8**, !dbg !298
...
if.then4:                                         ; preds = %land.lhs.true
  %out2D_last = getelementptr inbounds i8* %call, i64 72, !dbg !299
  %7 = bitcast i8* %out2D_last to i32**, !dbg !299
...
; Function Attrs: optsize
declare i32 @IOASCII_Write2D(%struct.cGH*, i32, i8*) #3
...
entry:
  ...
  %.off22 = add i32 %0, -2, !dbg !321
  %1 = icmp ugt i32 %.off22, 1, !dbg !321
  br i1 %1, label %if.then9, label %if.end8, !dbg !321

if.end8:                                          ; preds = %entry
  %grouptype = getelementptr inbounds %struct.cGroup* %groupinfo, i64 0, i32 0, !dbg !322
  %2 = load i32* %grouptype, align 4, !dbg !322, !tbaa !231
  %.off = add i32 %2, -2, !dbg !322
  ...
  br i1 %switch, label %if.end12, label %if.then9, !dbg !326

if.then9:                                         ; preds = %if.end8, %entry
  %errormsg.019 = phi i8* [ %., %if.end8 ], [ getelementptr inbounds ([45 x i8]* @.str3, i64 0, i64 0), %entry ]
  %call10 = call i8* @CCTK_FullName(i32 %vindex) #6, !dbg !327
  call void @llvm.dbg.value(metadata !{i8* %call10}, i64 0, metadata !138), !dbg !327
  %call11 = call i32 (i32, i32, i8*, i8*, i8*, ...)* @CCTK_VWarn(i32 2, i32 398, i8* getelementptr inbounds ([66 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i8* %errormsg.019, i8* %call10) #6, !dbg !329
  call void @free(i8* %call10) #6, !dbg !330
  br label %if.end12, !dbg !331

if.end12:                                         ; preds = %if.end8, %if.then9
  %tobool20 = phi i32 [ 1, %if.then9 ], [ 0, %if.end8 ]
  ret i32 %tobool20, !dbg !332
}
...
entry:
  ...
  %call3 = tail call i32 @IOASCII_Write2D(%struct.cGH* %GH, i32 %vindex, i8* %call2) #6, !dbg !336
...
if.then:                                          ; preds = %entry
  ...
  %out2D_last = getelementptr inbounds i8* %call, i64 72, !dbg !338
  %1 = bitcast i8* %out2D_last to i32**, !dbg !338
...
!0 = metadata !{i32 786449, metadata !1, i32 12, metadata !"clang version 3.3 (tags/RELEASE_33/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !223, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c] [DW_LANG_C99]
!1 = metadata !{metadata !"../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c", metadata !"/home/arquinn/Project1/EECS583/source_extraction_scripts"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4, metadata !11, metadata !94, metadata !103, metadata !112, metadata !119, metadata !140, metadata !215}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"CCTKi_version_CactusBase_IOASCII_Output2D_c", metadata !"CCTKi_version_CactusBase_IOASCII_Output2D_c", metadata !"", i32 25, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, i8* ()* @CCTKi_version_CactusBase_IOASCII_Output2D_c, null, null, metadata !2, i32 25} ; [ DW_TAG_subprogram ] [line 25] [def] [CCTKi_version_CactusBase_IOASCII_Output2D_c]
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
...
!11 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"IOASCII_Output2DGH", metadata !"IOASCII_Output2DGH", metadata !"", i32 61, metadata !12, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, i32 (%struct.cGH*)* @IOASCII_Output2DGH, null, null, metadata !53, i32 62} ; [ DW_TAG_subprogram ] [line 61] [def] [scope 62] [IOASCII_Output2DGH]
...
!94 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"IOASCII_Output2DVarAs", metadata !"IOASCII_Output2DVarAs", metadata !"", i32 146, metadata !95, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, i32 (%struct.cGH*, i8*, i8*)* @IOASCII_Output2DVarAs, null, null, metadata !97, i32 147} ; [ DW_TAG_subprogram ] [line 146] [def] [scope 147] [IOASCII_Output2DVarAs]
...
!103 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"IOASCII_TimeFor2D", metadata !"IOASCII_TimeFor2D", metadata !"", i32 196, metadata !104, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, i32 (%struct.cGH*, i32)* @IOASCII_TimeFor2D, null, null, metadata !106, i32 197} ; [ DW_TAG_subprogram ] [line 196] [def] [scope 197] [IOASCII_TimeFor2D]
...
!112 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"IOASCII_TriggerOutput2D", metadata !"IOASCII_TriggerOutput2D", metadata !"", i32 265, metadata !104, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, i32 (%struct.cGH*, i32)* @IOASCII_TriggerOutput2D, null, null, metadata !113, i32 266} ; [ DW_TAG_subprogram ] [line 265] [def] [scope 266] [IOASCII_TriggerOutput2D]
...
!224 = metadata !{i32 786484, i32 0, metadata !140, metadata !"out2D_vars_lastset", metadata !"out2D_vars_lastset", metadata !"", metadata !5, i32 302, metadata !14, i32 1, i32 1, i32* @CheckSteerableParameters.out2D_vars_lastset, null} ; [ DW_TAG_variable ] [out2D_vars_lastset] [line 302] [local] [def]
...
!235 = metadata !{i32 786443, metadata !1, metadata !11, i32 80, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
!236 = metadata !{i32 104, i32 0, metadata !237, null}
!237 = metadata !{i32 786443, metadata !1, metadata !238, i32 102, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
!238 = metadata !{i32 786443, metadata !1, metadata !235, i32 81, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
...
!254 = metadata !{i32 786443, metadata !1, metadata !140, i32 318, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
!255 = metadata !{i32 320, i32 0, metadata !254, null}
!256 = metadata !{i32 322, i32 0, metadata !257, null}
!257 = metadata !{i32 786443, metadata !1, metadata !254, i32 321, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
...
!262 = metadata !{i32 786443, metadata !1, metadata !140, i32 330, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
...
!269 = metadata !{i32 786443, metadata !1, metadata !262, i32 338, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
!270 = metadata !{i32 340, i32 0, metadata !271, null}
!271 = metadata !{i32 786443, metadata !1, metadata !269, i32 340, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
!272 = metadata !{i32 342, i32 0, metadata !273, null}
!273 = metadata !{i32 786443, metadata !1, metadata !271, i32 341, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
!274 = metadata !{i32 344, i32 0, metadata !275, null}
!275 = metadata !{i32 786443, metadata !1, metadata !273, i32 343, i32 0, i32 21} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
!276 = metadata !{i32 345, i32 0, metadata !275, null}
!277 = metadata !{i32 347, i32 0, metadata !278, null}
!278 = metadata !{i32 786443, metadata !1, metadata !275, i32 346, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
!279 = metadata !{i32 349, i32 0, metadata !278, null}
!280 = metadata !{i32 352, i32 0, metadata !281, null}
!281 = metadata !{i32 786443, metadata !1, metadata !275, i32 351, i32 0, i32 23} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
...
!286 = metadata !{i32 786443, metadata !1, metadata !269, i32 358, i32 0, i32 24} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
...
!300 = metadata !{i32 786443, metadata !1, metadata !103, i32 219, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
!301 = metadata !{i32 223, i32 0, metadata !302, null}
!302 = metadata !{i32 786443, metadata !1, metadata !300, i32 222, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
...
!313 = metadata !{i32 786443, metadata !1, metadata !94, i32 162, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
...
!325 = metadata !{i32 786443, metadata !1, metadata !119, i32 391, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
!326 = metadata !{i32 395, i32 0, metadata !119, null}
!327 = metadata !{i32 397, i32 0, metadata !328, null}
!328 = metadata !{i32 786443, metadata !1, metadata !119, i32 396, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
...
!339 = metadata !{i32 786443, metadata !1, metadata !112, i32 287, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
...
!346 = metadata !{i32 786443, metadata !1, metadata !215, i32 415, i32 0, i32 25} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
...
!350 = metadata !{i32 786443, metadata !1, metadata !215, i32 420, i32 0, i32 26} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output2D.c]
