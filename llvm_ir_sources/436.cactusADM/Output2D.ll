...
define internal fastcc void @CheckSteerableParameters(%struct.IOASCIIGH* nocapture %myGH) #1 {
  ...
  %1 = load i8** getelementptr inbounds (%struct.anon* @ioasciipriv_, i64 0, i32 12), align 8, !tbaa !13
  %2 = load i32* getelementptr inbounds (%struct.anon* @ioasciipriv_, i64 0, i32 31), align 4, !tbaa !15
  ...
  %5 = getelementptr inbounds %struct.IOASCIIGH* %myGH, i64 0, i32 1
...
; <label>:20                                      ; preds = %14, %0, %17
  ...
  %22 = load i32* @CheckSteerableParameters.out2D_vars_lastset, align 4, !tbaa !12
  %23 = icmp eq i32 %21, %22
  br i1 %23, label %60, label %24

; <label>:24                                      ; preds = %20
  %25 = tail call i32 @CCTK_NumVars() #5
  %26 = getelementptr inbounds %struct.IOASCIIGH* %myGH, i64 0, i32 4
...
.thread:                                          ; preds = %38, %55, %35, %57
  store i32 %21, i32* @CheckSteerableParameters.out2D_vars_lastset, align 4, !tbaa !12
  br label %60
...
; <label>:20                                      ; preds = %15
  %21 = getelementptr inbounds i8* %1, i64 72
...
; <label>:4                                       ; preds = %0
  %5 = tail call i32 @IOASCII_Write2D(%struct.cGH* %GH, i32 %1, i8* %alias) #5
  br label %6
...
; <label>:7                                       ; preds = %0
  %8 = getelementptr inbounds %struct.cGroup* %groupinfo, i64 0, i32 0
  %9 = load i32* %8, align 4, !tbaa !24
  %10 = and i32 %9, -2
...
; <label>:11                                      ; preds = %0, %7
  ...
  %12 = call i8* @CCTK_FullName(i32 %vindex) #5
  %13 = call i32 (i32, i32, i8*, i8*, i8*, ...)* @CCTK_VWarn(i32 2, i32 398, i8* getelementptr inbounds ([78 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i8* %errormsg.0.ph, i8* %12) #5
...
define i32 @IOASCII_TriggerOutput2D(%struct.cGH* %GH, i32 %vindex) #1 {
  ...
  %3 = tail call i32 @IOASCII_Write2D(%struct.cGH* %GH, i32 %vindex, i8* %2) #5
  %4 = icmp eq i32 %3, 0
