...
define i8* @CCTKi_version_CactusBase_IOASCII_Output3D_c() #0 {
  ret i8* getelementptr inbounds ([55 x i8]* @.str3, i64 0, i64 0), !dbg !230
}
...
define i32 @IOASCII_Output3DGH(%struct.cGH* %GH) #1 {
  ...
  %3 = getelementptr inbounds i8* %1, i64 8, !dbg !237
...
.lr.ph:                                           ; preds = %.preheader
  ...
  %10 = getelementptr inbounds i8* %1, i64 80, !dbg !256
...
; <label>:12                                      ; preds = %.lr.ph, %25
  ...
  %14 = tail call i32 @IOASCII_TimeFor3D(%struct.cGH* %GH, i32 %13) #6, !dbg !257
...
; <label>:16                                      ; preds = %12
  ...
  %18 = tail call i32 @IOASCII_Write3D(%struct.cGH* %GH, i32 %13, i8* %17) #5, !dbg !262
...
define internal fastcc void @CheckSteerableParameters(%struct.IOASCIIGH* nocapture %myGH) #1 {
  ...
  %1 = load i8** getelementptr inbounds (%struct.anon* @ioasciipriv_, i64 0, i32 14), align 8, !dbg !277, !tbaa !278
  tail call void @llvm.dbg.value(metadata i8* %1, i64 0, metadata !145, metadata !231), !dbg !277
  %2 = load i32* getelementptr inbounds (%struct.anon* @ioasciipriv_, i64 0, i32 35), align 4, !dbg !277, !tbaa !280
  tail call void @llvm.dbg.value(metadata i32 %2, i64 0, metadata !167, metadata !231), !dbg !277
  ...
  %5 = getelementptr inbounds %struct.IOASCIIGH* %myGH, i64 0, i32 2, !dbg !284
...
; <label>:20                                      ; preds = %14, %0, %17
  ...
  %22 = load i32* @CheckSteerableParameters.out3D_vars_lastset, align 4, !dbg !307, !tbaa !271
...
; <label>:24                                      ; preds = %20
  ...
  %26 = getelementptr inbounds %struct.IOASCIIGH* %myGH, i64 0, i32 5, !dbg !314
...
.thread:                                          ; preds = %38, %55, %35, %57
  store i32 %21, i32* @CheckSteerableParameters.out3D_vars_lastset, align 4, !dbg !359, !tbaa !271
  br label %60, !dbg !360
...
define i32 @IOASCII_TimeFor3D(%struct.cGH* %GH, i32 %vindex) #1 {
  ...
  %3 = getelementptr inbounds i8* %1, i64 8, !dbg !369
...
; <label>:7                                       ; preds = %0
  ...
  %9 = getelementptr inbounds i8* %1, i64 32, !dbg !375
...
; <label>:20                                      ; preds = %15
  %21 = getelementptr inbounds i8* %1, i64 80, !dbg !381
...
; <label>:4                                       ; preds = %0
  %5 = tail call i32 @IOASCII_Write3D(%struct.cGH* %GH, i32 %1, i8* %alias) #5, !dbg !404
...
define internal fastcc i32 @CheckOutputVar(i32 %vindex) #1 {
  ...
  %5 = icmp eq i32 %4, 3, !dbg !418
  br i1 %5, label %6, label %10, !dbg !419

; <label>:6                                       ; preds = %0
  %7 = getelementptr inbounds %struct.cGroup* %groupinfo, i64 0, i32 0, !dbg !420
  %8 = load i32* %7, align 4, !dbg !420, !tbaa !422
  %9 = and i32 %8, -2, !dbg !423
  %switch = icmp eq i32 %9, 2, !dbg !423
...
; <label>:10                                      ; preds = %0, %6
  ...
  %11 = call i8* @CCTK_FullName(i32 %vindex) #5, !dbg !424
  call void @llvm.dbg.value(metadata i8* %11, i64 0, metadata !221, metadata !231), !dbg !427
  %12 = call i32 (i32, i32, i8*, i8*, i8*, ...)* @CCTK_VWarn(i32 2, i32 398, i8* getelementptr inbounds ([78 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i8* %errormsg.0.ph, i8* %11) #5, !dbg !428
  call void @free(i8* %11) #6, !dbg !429
  br label %13, !dbg !430
...
define i32 @IOASCII_TriggerOutput3D(%struct.cGH* %GH, i32 %vindex) #1 {
  tail call void @llvm.dbg.value(metadata %struct.cGH* %GH, i64 0, metadata !114, metadata !231), !dbg !432
  tail call void @llvm.dbg.value(metadata i32 %vindex, i64 0, metadata !115, metadata !231), !dbg !433
  %1 = tail call i8* @CCTK_GHExtension(%struct.cGH* %GH, i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0)) #5, !dbg !434
  %2 = tail call i8* @CCTK_VarName(i32 %vindex) #5, !dbg !435
  tail call void @llvm.dbg.value(metadata i8* %2, i64 0, metadata !117, metadata !231), !dbg !436
  %3 = tail call i32 @IOASCII_Write3D(%struct.cGH* %GH, i32 %vindex, i8* %2) #5, !dbg !437
  tail call void @llvm.dbg.value(metadata i32 %3, i64 0, metadata !116, metadata !231), !dbg !438
  %4 = icmp eq i32 %3, 0, !dbg !439
  br i1 %4, label %5, label %13, !dbg !441

; <label>:5                                       ; preds = %0
  %6 = getelementptr inbounds %struct.cGH* %GH, i64 0, i32 1, !dbg !442
  %7 = load i32* %6, align 4, !dbg !442, !tbaa !265
  %8 = sext i32 %vindex to i64, !dbg !444
  %9 = getelementptr inbounds i8* %1, i64 80, !dbg !445
  %10 = bitcast i8* %9 to i32**, !dbg !445
  %11 = load i32** %10, align 8, !dbg !445, !tbaa !268
  %12 = getelementptr inbounds i32* %11, i64 %8, !dbg !444
  store i32 %7, i32* %12, align 4, !dbg !446, !tbaa !271
  br label %13, !dbg !447
...
define internal void @SetOutputFlag(i32 %vindex, i8* %optstring, i8* nocapture %arg) #1 {
  tail call void @llvm.dbg.value(metadata i32 %vindex, i64 0, metadata !198, metadata !231), !dbg !449
  tail call void @llvm.dbg.value(metadata i8* %optstring, i64 0, metadata !199, metadata !231), !dbg !450
  tail call void @llvm.dbg.value(metadata i8* %arg, i64 0, metadata !200, metadata !231), !dbg !451
  tail call void @llvm.dbg.value(metadata i8* %arg, i64 0, metadata !201, metadata !231), !dbg !452
  %1 = tail call fastcc i32 @CheckOutputVar(i32 %vindex) #6, !dbg !453
  %2 = icmp eq i32 %1, 0, !dbg !455
  br i1 %2, label %3, label %6, !dbg !456

; <label>:3                                       ; preds = %0
  %4 = sext i32 %vindex to i64, !dbg !457
  %5 = getelementptr inbounds i8* %arg, i64 %4, !dbg !457
  store i8 1, i8* %5, align 1, !dbg !459, !tbaa !336
  br label %6, !dbg !460

; <label>:6                                       ; preds = %3, %0
  %7 = icmp eq i8* %optstring, null, !dbg !461
  br i1 %7, label %10, label %8, !dbg !463

; <label>:8                                       ; preds = %6
  %9 = tail call i32 (i32, i32, i8*, i8*, i8*, ...)* @CCTK_VWarn(i32 5, i32 421, i8* getelementptr inbounds ([78 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([46 x i8]* @.str10, i64 0, i64 0), i8* %optstring) #5, !dbg !464
  br label %10, !dbg !466
...
!1 = !DIFile(filename: "../../SPEC_CPU2006v1.1/benchspec/CPU2006/436.cactusADM/src/IOASCII/Output3D.c", directory: "/Users/vaspol/Documents/classes/EECS583/ClassProject/source_extraction_scripts")
!2 = !{}
!3 = !{!4, !14, !36}
...
!44 = !DISubprogram(name: "CCTKi_version_CactusBase_IOASCII_Output3D_c", scope: !1, file: !1, line: 25, type: !45, isLocal: false, isDefinition: true, scopeLine: 25, flags: DIFlagPrototyped, isOptimized: true, function: i8* ()* @CCTKi_version_CactusBase_IOASCII_Output3D_c, variables: !2)
!45 = !DISubroutineType(types: !46)
!46 = !{!47}
!47 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !48, size: 64, align: 64)
!48 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !15)
!49 = !DISubprogram(name: "IOASCII_Output3DGH", scope: !1, file: !1, line: 61, type: !50, isLocal: false, isDefinition: true, scopeLine: 62, flags: DIFlagPrototyped, isOptimized: true, function: i32 (%struct.cGH*)* @IOASCII_Output3DGH, variables: !88)
...
!94 = !DISubprogram(name: "IOASCII_Output3DVarAs", scope: !1, file: !1, line: 146, type: !95, isLocal: false, isDefinition: true, scopeLine: 147, flags: DIFlagPrototyped, isOptimized: true, function: i32 (%struct.cGH*, i8*, i8*)* @IOASCII_Output3DVarAs, variables: !97)
...
!103 = !DISubprogram(name: "IOASCII_TimeFor3D", scope: !1, file: !1, line: 196, type: !104, isLocal: false, isDefinition: true, scopeLine: 197, flags: DIFlagPrototyped, isOptimized: true, function: i32 (%struct.cGH*, i32)* @IOASCII_TimeFor3D, variables: !106)
...
!112 = !DISubprogram(name: "IOASCII_TriggerOutput3D", scope: !1, file: !1, line: 265, type: !104, isLocal: false, isDefinition: true, scopeLine: 266, flags: DIFlagPrototyped, isOptimized: true, function: i32 (%struct.cGH*, i32)* @IOASCII_TriggerOutput3D, variables: !113)
...
!225 = !DIGlobalVariable(name: "out3D_vars_lastset", scope: !119, file: !1, line: 302, type: !10, isLocal: true, isDefinition: true, variable: i32* @CheckSteerableParameters.out3D_vars_lastset)
...
!418 = !DILocation(line: 386, column: 21, scope: !415)
!419 = !DILocation(line: 386, column: 7, scope: !202)
!420 = !DILocation(line: 390, column: 22, scope: !421)
!421 = distinct !DILexicalBlock(scope: !415, file: !1, line: 390, column: 12)
!422 = !{!417, !241, i64 0}
!423 = !DILocation(line: 390, column: 43, scope: !421)
!424 = !DILocation(line: 397, column: 16, scope: !425)
!425 = distinct !DILexicalBlock(scope: !426, file: !1, line: 396, column: 3)
!426 = distinct !DILexicalBlock(scope: !202, file: !1, line: 395, column: 7)
!427 = !DILocation(line: 376, column: 9, scope: !202)
!428 = !DILocation(line: 398, column: 5, scope: !425)
!429 = !DILocation(line: 399, column: 5, scope: !425)
!430 = !DILocation(line: 400, column: 3, scope: !425)
!431 = !DILocation(line: 402, column: 3, scope: !202)
!432 = !DILocation(line: 265, column: 41, scope: !112)
!433 = !DILocation(line: 265, column: 49, scope: !112)
!434 = !DILocation(line: 273, column: 24, scope: !112)
!435 = !DILocation(line: 275, column: 9, scope: !112)
!436 = !DILocation(line: 268, column: 15, scope: !112)
!437 = !DILocation(line: 284, column: 12, scope: !112)
!438 = !DILocation(line: 267, column: 7, scope: !112)
!439 = !DILocation(line: 286, column: 14, scope: !440)
!440 = distinct !DILexicalBlock(scope: !112, file: !1, line: 286, column: 7)
!441 = !DILocation(line: 286, column: 7, scope: !112)
!442 = !DILocation(line: 289, column: 36, scope: !443)
!443 = distinct !DILexicalBlock(scope: !440, file: !1, line: 287, column: 3)
!444 = !DILocation(line: 289, column: 5, scope: !443)
!445 = !DILocation(line: 289, column: 11, scope: !443)
!446 = !DILocation(line: 289, column: 30, scope: !443)
!447 = !DILocation(line: 290, column: 3, scope: !443)
!448 = !DILocation(line: 292, column: 3, scope: !112)
!449 = !DILocation(line: 408, column: 32, scope: !194)
!450 = !DILocation(line: 408, column: 52, scope: !194)
!451 = !DILocation(line: 408, column: 69, scope: !194)
!452 = !DILocation(line: 410, column: 9, scope: !194)
!453 = !DILocation(line: 414, column: 7, scope: !454)
!454 = distinct !DILexicalBlock(scope: !194, file: !1, line: 414, column: 7)
!455 = !DILocation(line: 414, column: 31, scope: !454)
!456 = !DILocation(line: 414, column: 7, scope: !194)
!457 = !DILocation(line: 416, column: 5, scope: !458)
!458 = distinct !DILexicalBlock(scope: !454, file: !1, line: 415, column: 3)
!459 = !DILocation(line: 416, column: 19, scope: !458)
!460 = !DILocation(line: 417, column: 3, scope: !458)
!461 = !DILocation(line: 419, column: 7, scope: !462)
!462 = distinct !DILexicalBlock(scope: !194, file: !1, line: 419, column: 7)
!463 = !DILocation(line: 419, column: 7, scope: !194)
!464 = !DILocation(line: 421, column: 5, scope: !465)
!465 = distinct !DILexicalBlock(scope: !462, file: !1, line: 420, column: 3)
!466 = !DILocation(line: 423, column: 3, scope: !465)
!467 = !DILocation(line: 424, column: 1, scope: !194)
