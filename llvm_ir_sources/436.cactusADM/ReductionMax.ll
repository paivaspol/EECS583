...
define i32 @PUGH_ReductionMaxValArrays(%struct.cGH* %GH, i32 %proc, i32 %num_dims, i32* %dims, i32 %num_inarrays, i8** %inarrays, i32 %intype, i32 %num_outvals, i8* %outvals, i32 %outtype) #1 {
  %1 = tail call i32 @PUGH_ReductionArrays(%struct.cGH* %GH, i32 %proc, i32 %num_dims, i32* %dims, i32 %intype, i32 %num_inarrays, i8** %inarrays, i32 %outtype, i32 %num_outvals, i8* %outvals, i32 (%struct.cGH*, i32, i32, i32*, i32*, i32*, i32*, i32, i32, i32*, i8**, i32, double*)* @PUGH_ReductionMaxVal) #5
  ret i32 %1
}
...
; <label>:48                                      ; preds = %.lr.ph395, %48
  ...
  %52 = icmp ult i8 %typed_outval.1393, %51
...
; <label>:107                                     ; preds = %.lr.ph364, %107
  ...
  %111 = icmp slt i32 %typed_outval6.1362, %110
...
; <label>:166                                     ; preds = %.lr.ph333, %166
  ...
  %170 = icmp slt i16 %typed_outval12.1331, %169
...
; <label>:225                                     ; preds = %.lr.ph302, %225
  ...
  %229 = icmp slt i32 %typed_outval18.1300, %228
...
; <label>:284                                     ; preds = %.lr.ph271, %284
  ...
  %288 = icmp slt i64 %typed_outval24.1269, %287
...
; <label>:343                                     ; preds = %.lr.ph240, %343
  ...
  %347 = fcmp olt double %typed_outval30.1238, %346
...
; <label>:401                                     ; preds = %.lr.ph209, %401
  ...
  %405 = fcmp olt float %typed_outval36.1207, %404
...
; <label>:460                                     ; preds = %.lr.ph178, %460
  ...
  %464 = fcmp olt double %typed_outval42.1176, %463
...
; <label>:518                                     ; preds = %.lr.ph147, %518
  ...
  %522 = fcmp olt x86_fp80 %typed_outval48.1145, %521
...
; <label>:548                                     ; preds = %17
  %549 = tail call i32 @CCTK_Warn(i32 1, i32 305, i8* getelementptr inbounds ([85 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([11 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([85 x i8]* @.str3, i64 0, i64 0)) #5
  br label %.loopexit108

; <label>:550                                     ; preds = %17
  %551 = tail call i32 @CCTK_Warn(i32 1, i32 309, i8* getelementptr inbounds ([85 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([11 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([44 x i8]* @.str4, i64 0, i64 0)) #5
  br label %.loopexit108
...
define i32 @PUGH_ReductionMaxValGVs(%struct.cGH* %GH, i32 %proc, i32 %num_outvals, i32 %outtype, i8* %outvals, i32 %num_invars, i32* %invars) #1 {
  %1 = tail call i32 @PUGH_ReductionGVs(%struct.cGH* %GH, i32 %proc, i32 %num_invars, i32* %invars, i32 %outtype, i32 %num_outvals, i8* %outvals, i32 (%struct.cGH*, i32, i32, i32*, i32*, i32*, i32*, i32, i32, i32*, i8**, i32, double*)* @PUGH_ReductionMaxVal) #5
  ret i32 %1
}
