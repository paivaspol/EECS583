; ModuleID = '../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c'
...
@.str = private unnamed_addr constant [73 x i8] c"../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c\00", align 1
@.str1 = private unnamed_addr constant [11 x i8] c"PUGHReduce\00", align 1
@.str2 = private unnamed_addr constant [85 x i8] c"PUGH_ReductionMaxVal: Don't know how to compute the maximum of complex variables !!!\00", align 1
@.str3 = private unnamed_addr constant [44 x i8] c"PUGH_ReductionMaxVal: Unknown variable type\00", align 1
@.str4 = private unnamed_addr constant [59 x i8] c"$Id: ReductionMax.c,v 1.6 2001/11/05 15:04:13 tradke Exp $\00", align 1

; Function Attrs: nounwind optsize readnone uwtable
define i8* @CCTKi_version_CactusPUGH_PUGHReduce_ReductionMax_c() #0 {
entry:
  ret i8* getelementptr inbounds ([59 x i8]* @.str4, i64 0, i64 0), !dbg !172
}

; Function Attrs: nounwind optsize uwtable
define i32 @PUGH_ReductionMaxValArrays(%struct.cGH* %GH, i32 %proc, i32 %num_dims, i32* %dims, i32 %num_inarrays, i8** %inarrays, i32 %intype, i32 %num_outvals, i8* %outvals, i32 %outtype) #1 {
entry:
  ...
  %call = tail call i32 @PUGH_ReductionArrays(%struct.cGH* %GH, i32 %proc, i32 %num_dims, i32* %dims, i32 %intype, i32 %num_inarrays, i8** %inarrays, i32 %outtype, i32 %num_outvals, i8* %outvals, i32 (%struct.cGH*, i32, i32, i32*, i32*, i32*, i32*, i32, i32, i32*, i8**, i32, double*)* @PUGH_ReductionMaxVal) #5, !dbg !183
...
; Function Attrs: nounwind optsize uwtable
define internal i32 @PUGH_ReductionMaxVal(%struct.cGH* nocapture %GH, i32 %proc, i32 %num_dims, i32* %from, i32* %to, i32* %iterator, i32* nocapture %points_per_dim, i32 %num_points, i32 %num_inarrays, i32* nocapture %intypes, i8** nocapture %inarrays, i32 %num_outvals, double* nocapture %outvals) #1 {
entry:
...
for.body34:                                       ; preds = %for.body34.lr.ph, %for.body34
  ...
  %cmp40 = icmp ult i8 %typed_outval.11838, %15, !dbg !225
...
for.body151:                                      ; preds = %for.body151.lr.ph, %for.body151
  ...
  %cmp155 = icmp slt i32 %typed_outval108.11809, %38, !dbg !245
...
for.body272:                                      ; preds = %for.body272.lr.ph, %for.body272
  ...
  %cmp278 = icmp slt i16 %typed_outval229.11780, %61, !dbg !270
...
for.body395:                                      ; preds = %for.body395.lr.ph, %for.body395
  ...
  %cmp399 = icmp slt i32 %typed_outval352.11751, %84, !dbg !294
...
for.body516:                                      ; preds = %for.body516.lr.ph, %for.body516
  ...
  %cmp520 = icmp slt i64 %typed_outval473.11722, %107, !dbg !319
...
for.body637:                                      ; preds = %for.body637.lr.ph, %for.body637
  ...
  %cmp641 = fcmp olt double %typed_outval594.11693, %130, !dbg !343
...
for.body757:                                      ; preds = %for.body757.lr.ph, %for.body757
  ...
  %cmp761 = fcmp olt float %typed_outval714.11664, %153, !dbg !368
...
for.body878:                                      ; preds = %for.body878.lr.ph, %for.body878
  ...
  %cmp882 = fcmp olt double %typed_outval835.11635, %176, !dbg !392
...
for.body998:                                      ; preds = %for.body998.lr.ph, %for.body998
  ...
  %cmp1002 = fcmp olt x86_fp80 %typed_outval955.11607, %199, !dbg !417
...
sw.bb1068:                                        ; preds = %for.body
  %call = tail call i32 @CCTK_Warn(i32 1, i32 305, i8* getelementptr inbounds ([73 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([11 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([85 x i8]* @.str2, i64 0, i64 0)) #5, !dbg !428
  br label %return, !dbg !429

sw.default:                                       ; preds = %for.body
  %call1069 = tail call i32 @CCTK_Warn(i32 1, i32 309, i8* getelementptr inbounds ([73 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([11 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([44 x i8]* @.str3, i64 0, i64 0)) #5, !dbg !430
...
; Function Attrs: nounwind optsize uwtable
define i32 @PUGH_ReductionMaxValGVs(%struct.cGH* %GH, i32 %proc, i32 %num_outvals, i32 %outtype, i8* %outvals, i32 %num_invars, i32* %invars) #1 {
entry:
  ...
  %call = tail call i32 @PUGH_ReductionGVs(%struct.cGH* %GH, i32 %proc, i32 %num_invars, i32* %invars, i32 %outtype, i32 %num_outvals, i8* %outvals, i32 (%struct.cGH*, i32, i32, i32*, i32*, i32*, i32*, i32, i32, i32*, i8**, i32, double*)* @PUGH_ReductionMaxVal) #5, !dbg !440
...
!0 = metadata !{i32 786449, metadata !1, i32 12, metadata !"clang version 3.3 (tags/RELEASE_33/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !170, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c] [DW_LANG_C99]
!1 = metadata !{metadata !"../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c", metadata !"/home/arquinn/Project1/EECS583/source_extraction_scripts"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4, metadata !11, metadata !63, metadata !74}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"CCTKi_version_CactusPUGH_PUGHReduce_ReductionMax_c", metadata !"CCTKi_version_CactusPUGH_PUGHReduce_ReductionMax_c", metadata !"", i32 22, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, i8* ()* @CCTKi_version_CactusPUGH_PUGHReduce_ReductionMax_c, null, null, metadata !2, i32 22} ; [ DW_TAG_subprogram ] [line 22] [def] [CCTKi_version_CactusPUGH_PUGHReduce_ReductionMax_c]
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
...
!11 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"PUGH_ReductionMaxValArrays", metadata !"PUGH_ReductionMaxValArrays", metadata !"", i32 107, metadata !12, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, i32 (%struct.cGH*, i32, i32, i32*, i32, i8**, i32, i32, i8*, i32)* @PUGH_ReductionMaxValArrays, null, null, metadata !52, i32 117} ; [ DW_TAG_subprogram ] [line 107] [def] [scope 117] [PUGH_ReductionMaxValArrays]
...
!63 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"PUGH_ReductionMaxValGVs", metadata !"PUGH_ReductionMaxValGVs", metadata !"", i32 177, metadata !64, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, i32 (%struct.cGH*, i32, i32, i32, i8*, i32, i32*)* @PUGH_ReductionMaxValGVs, null, null, metadata !66, i32 184} ; [ DW_TAG_subprogram ] [line 177] [def] [scope 184] [PUGH_ReductionMaxValGVs]
...
!74 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"PUGH_ReductionMaxVal", metadata !"PUGH_ReductionMaxVal", metadata !"", i32 203, metadata !75, i1 true, i1 true, i32 0, i32 0, null, i32 256, i1 true, i32 (%struct.cGH*, i32, i32, i32*, i32*, i32*, i32*, i32, i32, i32*, i8**, i32, double*)* @PUGH_ReductionMaxVal, null, null, metadata !77, i32 216} ; [ DW_TAG_subprogram ] [line 203] [local] [def] [scope 216] [PUGH_ReductionMaxVal]
...
!94 = metadata !{i32 786443, metadata !1, metadata !95, i32 238, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!95 = metadata !{i32 786443, metadata !1, metadata !96, i32 236, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!96 = metadata !{i32 786443, metadata !1, metadata !97, i32 234, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!97 = metadata !{i32 786443, metadata !1, metadata !74, i32 233, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
...
!107 = metadata !{i32 786443, metadata !1, metadata !95, i32 244, i32 0, i32 17} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
...
!114 = metadata !{i32 786443, metadata !1, metadata !95, i32 251, i32 0, i32 31} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
...
!123 = metadata !{i32 786443, metadata !1, metadata !95, i32 259, i32 0, i32 45} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
...
!130 = metadata !{i32 786443, metadata !1, metadata !95, i32 267, i32 0, i32 59} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
...
!139 = metadata !{i32 786443, metadata !1, metadata !95, i32 274, i32 0, i32 73} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
...
!146 = metadata !{i32 786443, metadata !1, metadata !95, i32 281, i32 0, i32 87} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
...
!155 = metadata !{i32 786443, metadata !1, metadata !95, i32 289, i32 0, i32 101} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
...
!162 = metadata !{i32 786443, metadata !1, metadata !95, i32 297, i32 0, i32 115} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
...
!202 = metadata !{i32 786443, metadata !1, metadata !94, i32 238, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!203 = metadata !{i32 238, i32 0, metadata !204, null}
!204 = metadata !{i32 786443, metadata !1, metadata !205, i32 238, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!205 = metadata !{i32 786443, metadata !1, metadata !202, i32 238, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!206 = metadata !{i32 238, i32 0, metadata !205, null}
!207 = metadata !{i32 238, i32 0, metadata !208, null}
!208 = metadata !{i32 786443, metadata !1, metadata !209, i32 238, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!209 = metadata !{i32 786443, metadata !1, metadata !205, i32 238, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!210 = metadata !{i32 238, i32 0, metadata !211, null}
!211 = metadata !{i32 786443, metadata !1, metadata !212, i32 238, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!212 = metadata !{i32 786443, metadata !1, metadata !208, i32 238, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
...
!219 = metadata !{i32 1}
!220 = metadata !{i32 238, i32 0, metadata !209, null}
!221 = metadata !{i32 238, i32 0, metadata !222, null}
!222 = metadata !{i32 786443, metadata !1, metadata !209, i32 238, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!223 = metadata !{i32 238, i32 0, metadata !224, null}
!224 = metadata !{i32 786443, metadata !1, metadata !209, i32 238, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!225 = metadata !{i32 238, i32 0, metadata !226, null}
!226 = metadata !{i32 786443, metadata !1, metadata !224, i32 238, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!227 = metadata !{i32 238, i32 0, metadata !228, null}
!228 = metadata !{i32 786443, metadata !1, metadata !211, i32 238, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!229 = metadata !{i32 238, i32 0, metadata !230, null}
!230 = metadata !{i32 786443, metadata !1, metadata !212, i32 238, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!231 = metadata !{metadata !"double", metadata !215}
!232 = metadata !{i32 244, i32 0, metadata !107, null}
!233 = metadata !{i32 244, i32 0, metadata !234, null}
!234 = metadata !{i32 786443, metadata !1, metadata !107, i32 244, i32 0, i32 18} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!235 = metadata !{i32 244, i32 0, metadata !236, null}
!236 = metadata !{i32 786443, metadata !1, metadata !234, i32 244, i32 0, i32 19} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!237 = metadata !{i32 244, i32 0, metadata !238, null}
!238 = metadata !{i32 786443, metadata !1, metadata !236, i32 244, i32 0, i32 20} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!239 = metadata !{i32 244, i32 0, metadata !240, null}
!240 = metadata !{i32 786443, metadata !1, metadata !236, i32 244, i32 0, i32 21} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!241 = metadata !{i32 244, i32 0, metadata !242, null}
!242 = metadata !{i32 786443, metadata !1, metadata !240, i32 244, i32 0, i32 22} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!243 = metadata !{i32 244, i32 0, metadata !244, null}
!244 = metadata !{i32 786443, metadata !1, metadata !240, i32 244, i32 0, i32 23} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!245 = metadata !{i32 244, i32 0, metadata !246, null}
!246 = metadata !{i32 786443, metadata !1, metadata !244, i32 244, i32 0, i32 24} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!247 = metadata !{i32 244, i32 0, metadata !248, null}
!248 = metadata !{i32 786443, metadata !1, metadata !240, i32 244, i32 0, i32 25} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!249 = metadata !{i32 244, i32 0, metadata !250, null}
!250 = metadata !{i32 786443, metadata !1, metadata !251, i32 244, i32 0, i32 27} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!251 = metadata !{i32 786443, metadata !1, metadata !248, i32 244, i32 0, i32 26} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!252 = metadata !{i32 244, i32 0, metadata !253, null}
!253 = metadata !{i32 786443, metadata !1, metadata !250, i32 244, i32 0, i32 28} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!254 = metadata !{i32 244, i32 0, metadata !255, null}
!255 = metadata !{i32 786443, metadata !1, metadata !251, i32 244, i32 0, i32 29} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!256 = metadata !{i32 251, i32 0, metadata !114, null}
!257 = metadata !{i32 251, i32 0, metadata !258, null}
!258 = metadata !{i32 786443, metadata !1, metadata !114, i32 251, i32 0, i32 32} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!259 = metadata !{i32 251, i32 0, metadata !260, null}
!260 = metadata !{i32 786443, metadata !1, metadata !258, i32 251, i32 0, i32 33} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!261 = metadata !{i32 251, i32 0, metadata !262, null}
!262 = metadata !{i32 786443, metadata !1, metadata !260, i32 251, i32 0, i32 34} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!263 = metadata !{metadata !"short", metadata !215}
!264 = metadata !{i32 251, i32 0, metadata !265, null}
!265 = metadata !{i32 786443, metadata !1, metadata !260, i32 251, i32 0, i32 35} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!266 = metadata !{i32 251, i32 0, metadata !267, null}
!267 = metadata !{i32 786443, metadata !1, metadata !265, i32 251, i32 0, i32 36} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!268 = metadata !{i32 251, i32 0, metadata !269, null}
!269 = metadata !{i32 786443, metadata !1, metadata !265, i32 251, i32 0, i32 37} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!270 = metadata !{i32 251, i32 0, metadata !271, null}
!271 = metadata !{i32 786443, metadata !1, metadata !269, i32 251, i32 0, i32 38} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!272 = metadata !{i32 251, i32 0, metadata !273, null}
!273 = metadata !{i32 786443, metadata !1, metadata !265, i32 251, i32 0, i32 39} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!274 = metadata !{i32 251, i32 0, metadata !275, null}
!275 = metadata !{i32 786443, metadata !1, metadata !276, i32 251, i32 0, i32 41} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!276 = metadata !{i32 786443, metadata !1, metadata !273, i32 251, i32 0, i32 40} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!277 = metadata !{i32 251, i32 0, metadata !278, null}
!278 = metadata !{i32 786443, metadata !1, metadata !275, i32 251, i32 0, i32 42} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!279 = metadata !{i32 251, i32 0, metadata !280, null}
!280 = metadata !{i32 786443, metadata !1, metadata !276, i32 251, i32 0, i32 43} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!281 = metadata !{i32 259, i32 0, metadata !123, null}
!282 = metadata !{i32 259, i32 0, metadata !283, null}
!283 = metadata !{i32 786443, metadata !1, metadata !123, i32 259, i32 0, i32 46} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!284 = metadata !{i32 259, i32 0, metadata !285, null}
!285 = metadata !{i32 786443, metadata !1, metadata !283, i32 259, i32 0, i32 47} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!286 = metadata !{i32 259, i32 0, metadata !287, null}
!287 = metadata !{i32 786443, metadata !1, metadata !285, i32 259, i32 0, i32 48} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!288 = metadata !{i32 259, i32 0, metadata !289, null}
!289 = metadata !{i32 786443, metadata !1, metadata !285, i32 259, i32 0, i32 49} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!290 = metadata !{i32 259, i32 0, metadata !291, null}
!291 = metadata !{i32 786443, metadata !1, metadata !289, i32 259, i32 0, i32 50} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!292 = metadata !{i32 259, i32 0, metadata !293, null}
!293 = metadata !{i32 786443, metadata !1, metadata !289, i32 259, i32 0, i32 51} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!294 = metadata !{i32 259, i32 0, metadata !295, null}
!295 = metadata !{i32 786443, metadata !1, metadata !293, i32 259, i32 0, i32 52} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!296 = metadata !{i32 259, i32 0, metadata !297, null}
!297 = metadata !{i32 786443, metadata !1, metadata !289, i32 259, i32 0, i32 53} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!298 = metadata !{i32 259, i32 0, metadata !299, null}
!299 = metadata !{i32 786443, metadata !1, metadata !300, i32 259, i32 0, i32 55} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!300 = metadata !{i32 786443, metadata !1, metadata !297, i32 259, i32 0, i32 54} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!301 = metadata !{i32 259, i32 0, metadata !302, null}
!302 = metadata !{i32 786443, metadata !1, metadata !299, i32 259, i32 0, i32 56} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!303 = metadata !{i32 259, i32 0, metadata !304, null}
!304 = metadata !{i32 786443, metadata !1, metadata !300, i32 259, i32 0, i32 57} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!305 = metadata !{i32 267, i32 0, metadata !130, null}
!306 = metadata !{i32 267, i32 0, metadata !307, null}
!307 = metadata !{i32 786443, metadata !1, metadata !130, i32 267, i32 0, i32 60} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!308 = metadata !{i32 267, i32 0, metadata !309, null}
!309 = metadata !{i32 786443, metadata !1, metadata !307, i32 267, i32 0, i32 61} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!310 = metadata !{i32 267, i32 0, metadata !311, null}
!311 = metadata !{i32 786443, metadata !1, metadata !309, i32 267, i32 0, i32 62} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!312 = metadata !{metadata !"long", metadata !215}
!313 = metadata !{i32 267, i32 0, metadata !314, null}
!314 = metadata !{i32 786443, metadata !1, metadata !309, i32 267, i32 0, i32 63} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!315 = metadata !{i32 267, i32 0, metadata !316, null}
!316 = metadata !{i32 786443, metadata !1, metadata !314, i32 267, i32 0, i32 64} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!317 = metadata !{i32 267, i32 0, metadata !318, null}
!318 = metadata !{i32 786443, metadata !1, metadata !314, i32 267, i32 0, i32 65} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!319 = metadata !{i32 267, i32 0, metadata !320, null}
!320 = metadata !{i32 786443, metadata !1, metadata !318, i32 267, i32 0, i32 66} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!321 = metadata !{i32 267, i32 0, metadata !322, null}
!322 = metadata !{i32 786443, metadata !1, metadata !314, i32 267, i32 0, i32 67} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!323 = metadata !{i32 267, i32 0, metadata !324, null}
!324 = metadata !{i32 786443, metadata !1, metadata !325, i32 267, i32 0, i32 69} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!325 = metadata !{i32 786443, metadata !1, metadata !322, i32 267, i32 0, i32 68} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!326 = metadata !{i32 267, i32 0, metadata !327, null}
!327 = metadata !{i32 786443, metadata !1, metadata !324, i32 267, i32 0, i32 70} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!328 = metadata !{i32 267, i32 0, metadata !329, null}
!329 = metadata !{i32 786443, metadata !1, metadata !325, i32 267, i32 0, i32 71} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!330 = metadata !{i32 274, i32 0, metadata !139, null}
!331 = metadata !{i32 274, i32 0, metadata !332, null}
!332 = metadata !{i32 786443, metadata !1, metadata !139, i32 274, i32 0, i32 74} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!333 = metadata !{i32 274, i32 0, metadata !334, null}
!334 = metadata !{i32 786443, metadata !1, metadata !332, i32 274, i32 0, i32 75} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!335 = metadata !{i32 274, i32 0, metadata !336, null}
!336 = metadata !{i32 786443, metadata !1, metadata !334, i32 274, i32 0, i32 76} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!337 = metadata !{i32 274, i32 0, metadata !338, null}
!338 = metadata !{i32 786443, metadata !1, metadata !334, i32 274, i32 0, i32 77} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!339 = metadata !{i32 274, i32 0, metadata !340, null}
!340 = metadata !{i32 786443, metadata !1, metadata !338, i32 274, i32 0, i32 78} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!341 = metadata !{i32 274, i32 0, metadata !342, null}
!342 = metadata !{i32 786443, metadata !1, metadata !338, i32 274, i32 0, i32 79} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!343 = metadata !{i32 274, i32 0, metadata !344, null}
!344 = metadata !{i32 786443, metadata !1, metadata !342, i32 274, i32 0, i32 80} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!345 = metadata !{i32 274, i32 0, metadata !346, null}
!346 = metadata !{i32 786443, metadata !1, metadata !338, i32 274, i32 0, i32 81} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!347 = metadata !{i32 274, i32 0, metadata !348, null}
!348 = metadata !{i32 786443, metadata !1, metadata !349, i32 274, i32 0, i32 83} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!349 = metadata !{i32 786443, metadata !1, metadata !346, i32 274, i32 0, i32 82} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!350 = metadata !{i32 274, i32 0, metadata !351, null}
!351 = metadata !{i32 786443, metadata !1, metadata !348, i32 274, i32 0, i32 84} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!352 = metadata !{i32 274, i32 0, metadata !353, null}
!353 = metadata !{i32 786443, metadata !1, metadata !349, i32 274, i32 0, i32 85} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!354 = metadata !{i32 281, i32 0, metadata !146, null}
!355 = metadata !{i32 281, i32 0, metadata !356, null}
!356 = metadata !{i32 786443, metadata !1, metadata !146, i32 281, i32 0, i32 88} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!357 = metadata !{i32 281, i32 0, metadata !358, null}
!358 = metadata !{i32 786443, metadata !1, metadata !356, i32 281, i32 0, i32 89} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!359 = metadata !{i32 281, i32 0, metadata !360, null}
!360 = metadata !{i32 786443, metadata !1, metadata !358, i32 281, i32 0, i32 90} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!361 = metadata !{metadata !"float", metadata !215}
!362 = metadata !{i32 281, i32 0, metadata !363, null}
!363 = metadata !{i32 786443, metadata !1, metadata !358, i32 281, i32 0, i32 91} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!364 = metadata !{i32 281, i32 0, metadata !365, null}
!365 = metadata !{i32 786443, metadata !1, metadata !363, i32 281, i32 0, i32 92} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!366 = metadata !{i32 281, i32 0, metadata !367, null}
!367 = metadata !{i32 786443, metadata !1, metadata !363, i32 281, i32 0, i32 93} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!368 = metadata !{i32 281, i32 0, metadata !369, null}
!369 = metadata !{i32 786443, metadata !1, metadata !367, i32 281, i32 0, i32 94} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!370 = metadata !{i32 281, i32 0, metadata !371, null}
!371 = metadata !{i32 786443, metadata !1, metadata !363, i32 281, i32 0, i32 95} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!372 = metadata !{i32 281, i32 0, metadata !373, null}
!373 = metadata !{i32 786443, metadata !1, metadata !374, i32 281, i32 0, i32 97} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!374 = metadata !{i32 786443, metadata !1, metadata !371, i32 281, i32 0, i32 96} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!375 = metadata !{i32 281, i32 0, metadata !376, null}
!376 = metadata !{i32 786443, metadata !1, metadata !373, i32 281, i32 0, i32 98} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!377 = metadata !{i32 281, i32 0, metadata !378, null}
!378 = metadata !{i32 786443, metadata !1, metadata !374, i32 281, i32 0, i32 99} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!379 = metadata !{i32 289, i32 0, metadata !155, null}
!380 = metadata !{i32 289, i32 0, metadata !381, null}
!381 = metadata !{i32 786443, metadata !1, metadata !155, i32 289, i32 0, i32 102} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!382 = metadata !{i32 289, i32 0, metadata !383, null}
!383 = metadata !{i32 786443, metadata !1, metadata !381, i32 289, i32 0, i32 103} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!384 = metadata !{i32 289, i32 0, metadata !385, null}
!385 = metadata !{i32 786443, metadata !1, metadata !383, i32 289, i32 0, i32 104} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!386 = metadata !{i32 289, i32 0, metadata !387, null}
!387 = metadata !{i32 786443, metadata !1, metadata !383, i32 289, i32 0, i32 105} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!388 = metadata !{i32 289, i32 0, metadata !389, null}
!389 = metadata !{i32 786443, metadata !1, metadata !387, i32 289, i32 0, i32 106} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!390 = metadata !{i32 289, i32 0, metadata !391, null}
!391 = metadata !{i32 786443, metadata !1, metadata !387, i32 289, i32 0, i32 107} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!392 = metadata !{i32 289, i32 0, metadata !393, null}
!393 = metadata !{i32 786443, metadata !1, metadata !391, i32 289, i32 0, i32 108} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!394 = metadata !{i32 289, i32 0, metadata !395, null}
!395 = metadata !{i32 786443, metadata !1, metadata !387, i32 289, i32 0, i32 109} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!396 = metadata !{i32 289, i32 0, metadata !397, null}
!397 = metadata !{i32 786443, metadata !1, metadata !398, i32 289, i32 0, i32 111} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!398 = metadata !{i32 786443, metadata !1, metadata !395, i32 289, i32 0, i32 110} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!399 = metadata !{i32 289, i32 0, metadata !400, null}
!400 = metadata !{i32 786443, metadata !1, metadata !397, i32 289, i32 0, i32 112} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!401 = metadata !{i32 289, i32 0, metadata !402, null}
!402 = metadata !{i32 786443, metadata !1, metadata !398, i32 289, i32 0, i32 113} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!403 = metadata !{i32 297, i32 0, metadata !162, null}
!404 = metadata !{i32 297, i32 0, metadata !405, null}
!405 = metadata !{i32 786443, metadata !1, metadata !162, i32 297, i32 0, i32 116} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!406 = metadata !{i32 297, i32 0, metadata !407, null}
!407 = metadata !{i32 786443, metadata !1, metadata !405, i32 297, i32 0, i32 117} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!408 = metadata !{i32 297, i32 0, metadata !409, null}
!409 = metadata !{i32 786443, metadata !1, metadata !407, i32 297, i32 0, i32 118} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!410 = metadata !{metadata !"long double", metadata !215}
!411 = metadata !{i32 297, i32 0, metadata !412, null}
!412 = metadata !{i32 786443, metadata !1, metadata !407, i32 297, i32 0, i32 119} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!413 = metadata !{i32 297, i32 0, metadata !414, null}
!414 = metadata !{i32 786443, metadata !1, metadata !412, i32 297, i32 0, i32 120} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!415 = metadata !{i32 297, i32 0, metadata !416, null}
!416 = metadata !{i32 786443, metadata !1, metadata !412, i32 297, i32 0, i32 121} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!417 = metadata !{i32 297, i32 0, metadata !418, null}
!418 = metadata !{i32 786443, metadata !1, metadata !416, i32 297, i32 0, i32 122} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!419 = metadata !{i32 297, i32 0, metadata !420, null}
!420 = metadata !{i32 786443, metadata !1, metadata !412, i32 297, i32 0, i32 123} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!421 = metadata !{i32 297, i32 0, metadata !422, null}
!422 = metadata !{i32 786443, metadata !1, metadata !423, i32 297, i32 0, i32 125} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!423 = metadata !{i32 786443, metadata !1, metadata !420, i32 297, i32 0, i32 124} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!424 = metadata !{i32 297, i32 0, metadata !425, null}
!425 = metadata !{i32 786443, metadata !1, metadata !422, i32 297, i32 0, i32 126} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!426 = metadata !{i32 297, i32 0, metadata !427, null}
!427 = metadata !{i32 786443, metadata !1, metadata !423, i32 297, i32 0, i32 127} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/436.cactusADM/src/PUGHReduce/ReductionMax.c]
!428 = metadata !{i32 304, i32 0, metadata !95, null}
!429 = metadata !{i32 306, i32 0, metadata !95, null}
!430 = metadata !{i32 309, i32 0, metadata !95, null}
!431 = metadata !{i32 310, i32 0, metadata !95, null}
