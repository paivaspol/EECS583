...
define i32 @CCTKi_BindingsIDLinearWavesParameterExtensions() #0 {
  %1 = tail call i32 @CCTKi_ParameterAddRange(i8* getelementptr inbounds ([9 x i8]* @.str59, i64 0, i64 0), i8* getelementptr inbounds ([13 x i8]* @.str60, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8]* @.str61, i64 0, i64 0), i8* getelementptr inbounds ([43 x i8]* @.str62, i64 0, i64 0)) #2
  %2 = tail call i32 @CCTKi_ParameterAddRange(i8* getelementptr inbounds ([9 x i8]* @.str59, i64 0, i64 0), i8* getelementptr inbounds ([13 x i8]* @.str60, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([11 x i8]* @.str63, i64 0, i64 0), i8* getelementptr inbounds ([39 x i8]* @.str64, i64 0, i64 0)) #2
  ret i32 0
}
