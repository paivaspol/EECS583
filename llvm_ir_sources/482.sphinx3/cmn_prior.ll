; ModuleID = '../../SPEC/benchspec/CPU2006/482.sphinx3/src/cmn_prior.c'
...
@cmn_prior.initialize = internal unnamed_addr global i1 false
@.str = private unnamed_addr constant [57 x i8] c"../../SPEC/benchspec/CPU2006/482.sphinx3/src/cmn_prior.c\00", align 1
@.str1 = private unnamed_addr constant [12 x i8] c"FATAL_ERROR\00", align 1
@.str2 = private unnamed_addr constant [60 x i8] c"Variance normalization not implemented in live mode decode\0A\00", align 1
@.str3 = private unnamed_addr constant [5 x i8] c"INFO\00", align 1
@.str4 = private unnamed_addr constant [33 x i8] c"mean[0]= %.2f, mean[1..%d]= 0.0\0A\00", align 1
