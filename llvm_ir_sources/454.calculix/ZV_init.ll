...
if.then:                                          ; preds = %entry
  ...
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([47 x i8]* @.str, i64 0, i64 0), %struct._ZV* %zv, i32 %size, double* %entries) #4
  tail call void @exit(i32 -1) #5
  unreachable

if.end:                                           ; preds = %entry
  tail call void @ZV_clearData(%struct._ZV* %zv) #4
  %size2 = getelementptr inbounds %struct._ZV* %zv, i64 0, i32 0
...
if.then6:                                         ; preds = %if.else
  %owned7 = getelementptr inbounds %struct._ZV* %zv, i64 0, i32 2
  store i32 1, i32* %owned7, align 4, !tbaa !3
  %mul = shl nsw i32 %size, 1
  %call8 = tail call double* @DVinit(i32 %mul, double 0.000000e+00) #4
  %vec9 = getelementptr inbounds %struct._ZV* %zv, i64 0, i32 3
...
entry:
  tail call void @ZV_init(%struct._ZV* %zv, i32 %size, double* null) #6
  ret void
}
...
if.then:                                          ; preds = %entry
  %0 = load %struct._IO_FILE** @stderr, align 8, !tbaa !0
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([54 x i8]* @.str1, i64 0, i64 0), %struct._ZV* null, i32 %size, i32 %maxsize, i32 %owned, double* %vec) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.then3:                                         ; preds = %if.end
  ...
  %call4 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([69 x i8]* @.str2, i64 0, i64 0), %struct._ZV* %zv, i32 %size, i32 %maxsize, i32 %owned, double* %vec, i32 %size, i32 %maxsize) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.then9:                                         ; preds = %if.end5
  ...
  %call10 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %3, i8* getelementptr inbounds ([55 x i8]* @.str3, i64 0, i64 0), %struct._ZV* %zv, i32 %size, i32 %maxsize, i32 %owned, double* %vec, i32 %owned) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.then14:                                        ; preds = %if.end11
  ...
  %call15 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([67 x i8]* @.str4, i64 0, i64 0), %struct._ZV* %zv, i32 %size, i32 %maxsize, i32 1, double* null, i32 1, double* null) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.else:                                          ; preds = %if.end16
  %size19 = getelementptr inbounds %struct._ZV* %zv, i64 0, i32 0
  store i32 %size, i32* %size19, align 4, !tbaa !3
  %maxsize20 = getelementptr inbounds %struct._ZV* %zv, i64 0, i32 1
  store i32 %maxsize, i32* %maxsize20, align 4, !tbaa !3
  %owned21 = getelementptr inbounds %struct._ZV* %zv, i64 0, i32 2
  store i32 %owned, i32* %owned21, align 4, !tbaa !3
  %vec22 = getelementptr inbounds %struct._ZV* %zv, i64 0, i32 3
...
if.then:                                          ; preds = %entry
  %0 = load %struct._IO_FILE** @stderr, align 8, !tbaa !0
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([50 x i8]* @.str5, i64 0, i64 0), %struct._ZV* %zv, i32 %newmaxsize) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.then4:                                         ; preds = %land.lhs.true
  %3 = load %struct._IO_FILE** @stderr, align 8, !tbaa !0
  %call7 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %3, i8* getelementptr inbounds ([73 x i8]* @.str6, i64 0, i64 0), %struct._ZV* %zv, i32 %newmaxsize, i32 %1, i32 0) #4
  tail call void @exit(i32 -1) #5
  unreachable

if.end8:                                          ; preds = %land.lhs.true, %if.end
  %cmp10 = icmp eq i32 %1, %newmaxsize
  br i1 %cmp10, label %if.end40, label %if.then11

if.then11:                                        ; preds = %if.end8
  %mul = shl nsw i32 %newmaxsize, 1
  %call12 = tail call double* @DVinit(i32 %mul, double 0.000000e+00) #4
  %size = getelementptr inbounds %struct._ZV* %zv, i64 0, i32 0
  %4 = load i32* %size, align 4, !tbaa !3
  %cmp13 = icmp sgt i32 %4, 0
  %vec15 = getelementptr inbounds %struct._ZV* %zv, i64 0, i32 3
...
if.then17:                                        ; preds = %if.then14
  ...
  %call19 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %6, i8* getelementptr inbounds ([71 x i8]* @.str7, i64 0, i64 0), %struct._ZV* %zv, i32 %newmaxsize, i32 %4) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.then23:                                        ; preds = %if.end20
  ...
  tail call void @DVcopy(i32 %mul25, double* %call12, double* %5) #4
  br label %if.end31

if.else:                                          ; preds = %if.end20
  tail call void @DVcopy(i32 %mul, double* %call12, double* %5) #4
  store i32 %newmaxsize, i32* %size, align 4, !tbaa !3
  br label %if.end31

if.end31:                                         ; preds = %if.then11, %if.then23, %if.else
  %7 = load double** %vec15, align 8, !tbaa !0
  %cmp33 = icmp eq double* %7, null
...
if.end36:                                         ; preds = %if.end31, %if.then34
  ...
  %owned38 = getelementptr inbounds %struct._ZV* %zv, i64 0, i32 2
  store i32 1, i32* %owned38, align 4, !tbaa !3
...
if.then:                                          ; preds = %entry
  %0 = load %struct._IO_FILE** @stderr, align 8, !tbaa !0
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([47 x i8]* @.str8, i64 0, i64 0), %struct._ZV* %zv, i32 %newsize) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.then7:                                         ; preds = %land.lhs.true5
  %3 = load %struct._IO_FILE** @stderr, align 8, !tbaa !0
  %call10 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %3, i8* getelementptr inbounds ([84 x i8]* @.str9, i64 0, i64 0), %struct._ZV* %zv, i32 %newsize, i32 %1, i32 %newsize, i32 0) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.then14:                                        ; preds = %if.end11
  tail call void @ZV_setMaxsize(%struct._ZV* %zv, i32 %newsize) #6
  br label %if.end15
