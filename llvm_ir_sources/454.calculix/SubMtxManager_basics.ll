...
entry:
  ...
  %0 = bitcast i8* %call to %struct._SubMtxManager*
  %cmp = icmp eq i8* %call, null
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %1 = load %struct._IO_FILE** @stderr, align 8, !tbaa !0
  %call1 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([49 x i8]* @.str, i64 0, i64 0), i64 56, i32 21, i8* getelementptr inbounds ([95 x i8]* @.str1, i64 0, i64 0)) #5
  tail call void @exit(i32 -1) #6
  unreachable

if.end:                                           ; preds = %entry
  tail call void @SubMtxManager_setDefaultFields(%struct._SubMtxManager* %0) #7
  ret %struct._SubMtxManager* %0
}
...
if.then:                                          ; preds = %entry
  ...
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([63 x i8]* @.str2, i64 0, i64 0), %struct._SubMtxManager* null) #5
  tail call void @exit(i32 -1) #6
  unreachable

if.end:                                           ; preds = %entry
  %1 = bitcast %struct._SubMtxManager* %manager to i8*
...
while.cond.preheader:                             ; preds = %entry
  ...
  %0 = load %struct._SubMtx** %head, align 8, !tbaa !0
  %cmp114 = icmp eq %struct._SubMtx* %0, null
  br i1 %cmp114, label %while.end, label %while.body

if.then:                                          ; preds = %entry
  %1 = load %struct._IO_FILE** @stderr, align 8, !tbaa !0
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([57 x i8]* @.str3, i64 0, i64 0), %struct._SubMtxManager* null) #5
  tail call void @exit(i32 -1) #6
  unreachable

while.body:                                       ; preds = %while.cond.preheader, %while.body
  %2 = phi %struct._SubMtx* [ %4, %while.body ], [ %0, %while.cond.preheader ]
  %next = getelementptr inbounds %struct._SubMtx* %2, i64 0, i32 9
  %3 = load %struct._SubMtx** %next, align 8, !tbaa !0
  store %struct._SubMtx* %3, %struct._SubMtx** %head, align 8, !tbaa !0
  tail call void @SubMtx_free(%struct._SubMtx* %2) #5
  %4 = load %struct._SubMtx** %head, align 8, !tbaa !0
  %cmp1 = icmp eq %struct._SubMtx* %4, null
...
if.end6:                                          ; preds = %while.end, %if.then4
  tail call void @SubMtxManager_setDefaultFields(%struct._SubMtxManager* %manager) #7
  ret void
}
...
if.then:                                          ; preds = %entry
  %0 = load %struct._IO_FILE** @stderr, align 8, !tbaa !0
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([52 x i8]* @.str4, i64 0, i64 0), %struct._SubMtxManager* null) #5
  tail call void @exit(i32 -1) #6
  unreachable

if.end:                                           ; preds = %entry
  tail call void @SubMtxManager_clearData(%struct._SubMtxManager* %manager) #7
  %1 = bitcast %struct._SubMtxManager* %manager to i8*
