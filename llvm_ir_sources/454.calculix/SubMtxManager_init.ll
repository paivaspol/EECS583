...
if.then:                                          ; preds = %entry
  ...
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %2, i8* getelementptr inbounds ([58 x i8]* @.str, i64 0, i64 0), %struct._SubMtxManager* %manager, i32 %lockflag, i32 %mode) #4
  tail call void @exit(i32 -1) #5
  unreachable

if.end:                                           ; preds = %entry
  tail call void @SubMtxManager_clearData(%struct._SubMtxManager* %manager) #4
  %cmp8 = icmp eq i32 %lockflag, 0
...
if.end12:                                         ; preds = %if.end, %if.then9
  %mode13 = getelementptr inbounds %struct._SubMtxManager* %manager, i64 0, i32 2
