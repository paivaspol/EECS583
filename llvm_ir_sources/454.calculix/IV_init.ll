...
if.then:                                          ; preds = %entry
  ...
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([47 x i8]* @.str, i64 0, i64 0), %struct._IV* %iv, i32 %size, i32* %entries) #4
...
if.then4:                                         ; preds = %if.end
  ...
  store i32* %entries, i32** %vec, align 8, !tbaa !0
  br label %if.end11
...
if.then6:                                         ; preds = %if.else
  %owned7 = getelementptr inbounds %struct._IV* %iv, i64 0, i32 2
  store i32 1, i32* %owned7, align 4, !tbaa !3
  %call8 = tail call i32* @IVinit(i32 %size, i32 -1) #4
  %vec9 = getelementptr inbounds %struct._IV* %iv, i64 0, i32 3
  store i32* %call8, i32** %vec9, align 8, !tbaa !0
  br label %if.end11
...
entry:
  tail call void @IV_init(%struct._IV* %iv, i32 %size, i32* null) #6
  ret void
}
...
if.then:                                          ; preds = %entry
  %0 = load %struct._IO_FILE** @stderr, align 8, !tbaa !0
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([54 x i8]* @.str1, i64 0, i64 0), %struct._IV* null, i32 %size, i32 %maxsize, i32 %owned, i32* %vec) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.then3:                                         ; preds = %if.end
  ...
  %call4 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([69 x i8]* @.str2, i64 0, i64 0), %struct._IV* %iv, i32 %size, i32 %maxsize, i32 %owned, i32* %vec, i32 %size, i32 %maxsize) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.then9:                                         ; preds = %if.end5
  ...
  %call10 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %3, i8* getelementptr inbounds ([55 x i8]* @.str3, i64 0, i64 0), %struct._IV* %iv, i32 %size, i32 %maxsize, i32 %owned, i32* %vec, i32 %owned) #4
  tail call void @exit(i32 -1) #5
  unreachable

if.end11:                                         ; preds = %if.end5
  %cmp12 = icmp eq i32 %owned, 1
  %cmp13 = icmp eq i32* %vec, null
  %or.cond64 = and i1 %cmp12, %cmp13
  br i1 %or.cond64, label %if.then14, label %if.end16

if.then14:                                        ; preds = %if.end11
  %4 = load %struct._IO_FILE** @stderr, align 8, !tbaa !0
  %call15 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([67 x i8]* @.str4, i64 0, i64 0), %struct._IV* %iv, i32 %size, i32 %maxsize, i32 1, i32* null, i32 1, i32* null) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.else:                                          ; preds = %if.end16
  %size19 = getelementptr inbounds %struct._IV* %iv, i64 0, i32 0
  store i32 %size, i32* %size19, align 4, !tbaa !3
  %maxsize20 = getelementptr inbounds %struct._IV* %iv, i64 0, i32 1
  store i32 %maxsize, i32* %maxsize20, align 4, !tbaa !3
  %owned21 = getelementptr inbounds %struct._IV* %iv, i64 0, i32 2
  store i32 %owned, i32* %owned21, align 4, !tbaa !3
  %vec22 = getelementptr inbounds %struct._IV* %iv, i64 0, i32 3
  store i32* %vec, i32** %vec22, align 8, !tbaa !0
  br label %if.end23
...
if.then:                                          ; preds = %entry
  %0 = load %struct._IO_FILE** @stderr, align 8, !tbaa !0
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([50 x i8]* @.str5, i64 0, i64 0), %struct._IV* %iv, i32 %newmaxsize) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.then4:                                         ; preds = %land.lhs.true
  %3 = load %struct._IO_FILE** @stderr, align 8, !tbaa !0
  %call7 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %3, i8* getelementptr inbounds ([73 x i8]* @.str6, i64 0, i64 0), %struct._IV* %iv, i32 %newmaxsize, i32 %1, i32 0) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.then11:                                        ; preds = %if.end8
  %call12 = tail call i32* @IVinit(i32 %newmaxsize, i32 -1) #4
  %size = getelementptr inbounds %struct._IV* %iv, i64 0, i32 0
  %4 = load i32* %size, align 4, !tbaa !3
  %cmp13 = icmp sgt i32 %4, 0
  %vec15 = getelementptr inbounds %struct._IV* %iv, i64 0, i32 3
  br i1 %cmp13, label %if.then14, label %if.end29

if.then14:                                        ; preds = %if.then11
  %5 = load i32** %vec15, align 8, !tbaa !0
  %cmp16 = icmp eq i32* %5, null
  br i1 %cmp16, label %if.then17, label %if.end20

if.then17:                                        ; preds = %if.then14
  %6 = load %struct._IO_FILE** @stderr, align 8, !tbaa !0
  %call19 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %6, i8* getelementptr inbounds ([71 x i8]* @.str7, i64 0, i64 0), %struct._IV* %iv, i32 %newmaxsize, i32 %4) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.then23:                                        ; preds = %if.end20
  tail call void @IVcopy(i32 %4, i32* %call12, i32* %5) #4
  br label %if.end29

if.else:                                          ; preds = %if.end20
  tail call void @IVcopy(i32 %newmaxsize, i32* %call12, i32* %5) #4
  store i32 %newmaxsize, i32* %size, align 4, !tbaa !3
  br label %if.end29

if.end29:                                         ; preds = %if.then11, %if.then23, %if.else
  %7 = load i32** %vec15, align 8, !tbaa !0
  %cmp31 = icmp eq i32* %7, null
  br i1 %cmp31, label %if.end34, label %if.then32

if.then32:                                        ; preds = %if.end29
  tail call void @IVfree(i32* %7) #4
  br label %if.end34

if.end34:                                         ; preds = %if.end29, %if.then32
  store i32 %newmaxsize, i32* %maxsize, align 4, !tbaa !3
  %owned36 = getelementptr inbounds %struct._IV* %iv, i64 0, i32 2
  store i32 1, i32* %owned36, align 4, !tbaa !3
  store i32* %call12, i32** %vec15, align 8, !tbaa !0
  br label %if.end38
...
if.then:                                          ; preds = %entry
  %0 = load %struct._IO_FILE** @stderr, align 8, !tbaa !0
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([47 x i8]* @.str8, i64 0, i64 0), %struct._IV* %iv, i32 %newsize) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.then7:                                         ; preds = %land.lhs.true5
  %3 = load %struct._IO_FILE** @stderr, align 8, !tbaa !0
  %call10 = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %3, i8* getelementptr inbounds ([84 x i8]* @.str9, i64 0, i64 0), %struct._IV* %iv, i32 %newsize, i32 %1, i32 %newsize, i32 0) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.then14:                                        ; preds = %if.end11
  tail call void @IV_setMaxsize(%struct._IV* %iv, i32 %newsize) #6
  br label %if.end15
