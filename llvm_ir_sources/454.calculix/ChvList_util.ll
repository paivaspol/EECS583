...
if.then:                                          ; preds = %lor.lhs.false2, %entry
  ...
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([59 x i8]* @.str, i64 0, i64 0), %struct._ChvList* %chvlist, i32 %ilist) #4
  br label %if.end
...
if.end:                                           ; preds = %lor.lhs.false2, %if.then
  ...
  %2 = load %struct._Chv*** %heads, align 8, !tbaa !3
  %arrayidx = getelementptr inbounds %struct._Chv** %2, i64 %idxprom
  %3 = load %struct._Chv** %arrayidx, align 8, !tbaa !3
  %cmp4 = icmp ne %struct._Chv* %3, null
...
if.then:                                          ; preds = %lor.lhs.false2, %entry
  %1 = load %struct._IO_FILE** @stderr, align 8, !tbaa !3
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([56 x i8]* @.str1, i64 0, i64 0), %struct._ChvList* %chvlist, i32 %ilist) #4
  br label %if.end
...
if.then:                                          ; preds = %lor.lhs.false2, %entry
  %1 = load %struct._IO_FILE** @stderr, align 8, !tbaa !3
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([63 x i8]* @.str2, i64 0, i64 0), %struct._ChvList* %chvlist, %struct._Chv* %chv, i32 %ilist) #4
...
if.then10:                                        ; preds = %lor.lhs.false6, %land.lhs.true
  ...
  %cmp12 = icmp eq %struct._Chv* %chv, null
  br i1 %cmp12, label %if.end20, label %if.then14

if.then14:                                        ; preds = %if.then10
  %idxprom15 = sext i32 %ilist to i64
  %heads = getelementptr inbounds %struct._ChvList* %chvlist, i64 0, i32 1
  %5 = load %struct._Chv*** %heads, align 8, !tbaa !3
  %arrayidx16 = getelementptr inbounds %struct._Chv** %5, i64 %idxprom15
  %6 = load %struct._Chv** %arrayidx16, align 8, !tbaa !3
  %next = getelementptr inbounds %struct._Chv* %chv, i64 0, i32 10
  store %struct._Chv* %6, %struct._Chv** %next, align 8, !tbaa !3
  %7 = load %struct._Chv*** %heads, align 8, !tbaa !3
  %arrayidx19 = getelementptr inbounds %struct._Chv** %7, i64 %idxprom15
  store %struct._Chv* %chv, %struct._Chv** %arrayidx19, align 8, !tbaa !3
  br label %if.end20
...
if.end27:                                         ; preds = %if.end20, %if.then23
  %nlocks = getelementptr inbounds %struct._ChvList* %chvlist, i64 0, i32 5
...
if.else:                                          ; preds = %if.end, %lor.lhs.false6
  %cmp29 = icmp eq %struct._Chv* %chv, null
  br i1 %cmp29, label %if.end39, label %if.then31

if.then31:                                        ; preds = %if.else
  %idxprom32 = sext i32 %ilist to i64
  %heads33 = getelementptr inbounds %struct._ChvList* %chvlist, i64 0, i32 1
  %12 = load %struct._Chv*** %heads33, align 8, !tbaa !3
  %arrayidx34 = getelementptr inbounds %struct._Chv** %12, i64 %idxprom32
  %13 = load %struct._Chv** %arrayidx34, align 8, !tbaa !3
  %next35 = getelementptr inbounds %struct._Chv* %chv, i64 0, i32 10
  store %struct._Chv* %13, %struct._Chv** %next35, align 8, !tbaa !3
  %14 = load %struct._Chv*** %heads33, align 8, !tbaa !3
  %arrayidx38 = getelementptr inbounds %struct._Chv** %14, i64 %idxprom32
  store %struct._Chv* %chv, %struct._Chv** %arrayidx38, align 8, !tbaa !3
  br label %if.end39

if.end39:                                         ; preds = %if.else, %if.then31
  %counts40 = getelementptr inbounds %struct._ChvList* %chvlist, i64 0, i32 2
...
if.then:                                          ; preds = %lor.lhs.false2, %entry
  %1 = load %struct._IO_FILE** @stderr, align 8, !tbaa !3
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([52 x i8]* @.str3, i64 0, i64 0), %struct._ChvList* %chvlist, i32 %ilist) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.end:                                           ; preds = %lor.lhs.false2
  ...
  %arrayidx = getelementptr inbounds %struct._Chv** %2, i64 %idxprom
  %3 = load %struct._Chv** %arrayidx, align 8, !tbaa !3
  %cmp4 = icmp eq %struct._Chv* %3, null
...
if.then23:                                        ; preds = %land.lhs.true17, %land.lhs.true, %if.then5
  store %struct._Chv* null, %struct._Chv** %arrayidx, align 8, !tbaa !3
  br label %if.end40

if.else:                                          ; preds = %lor.lhs.false14, %land.lhs.true17
  tail call void @Lock_lock(%struct._Lock* %4) #4
  %9 = load %struct._Chv*** %heads, align 8, !tbaa !3
  %arrayidx33 = getelementptr inbounds %struct._Chv** %9, i64 %idxprom
  %10 = load %struct._Chv** %arrayidx33, align 8, !tbaa !3
  store %struct._Chv* null, %struct._Chv** %arrayidx33, align 8, !tbaa !3
  %nlocks = getelementptr inbounds %struct._ChvList* %chvlist, i64 0, i32 5
