...
entry:
  ...
  %0 = bitcast i8* %call to %struct._DV*
...
if.end:                                           ; preds = %entry
  tail call void @DV_setDefaultFields(%struct._DV* %0) #6
  ret %struct._DV* %0
}
...
if.then:                                          ; preds = %entry
  ...
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([53 x i8]* @.str2, i64 0, i64 0), %struct._DV* null) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.then:                                          ; preds = %entry
  %0 = load %struct._IO_FILE** @stderr, align 8, !tbaa !0
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([46 x i8]* @.str3, i64 0, i64 0), %struct._DV* null) #4
  tail call void @exit(i32 -1) #5
  unreachable
...
if.end5:                                          ; preds = %if.end, %if.then3, %land.lhs.true
  tail call void @DV_setDefaultFields(%struct._DV* %dv) #6
  ret void
}
...
if.then:                                          ; preds = %entry
  %0 = load %struct._IO_FILE** @stderr, align 8, !tbaa !0
  %call = tail call i32 (%struct._IO_FILE*, i8*, ...)* @fprintf(%struct._IO_FILE* %0, i8* getelementptr inbounds ([41 x i8]* @.str4, i64 0, i64 0), %struct._DV* null) #4
  tail call void @exit(i32 -1) #5
  unreachable

if.end:                                           ; preds = %entry
  tail call void @DV_clearData(%struct._DV* %dv) #6
  %1 = bitcast %struct._DV* %dv to i8*
