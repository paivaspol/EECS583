; ModuleID = '../../SPEC_CPU2006v1.1/benchspec/CPU2006/433.milc/src/s_m_a_mat.c'
...
; <label>:3                                       ; preds = %3, %.preheader
  ...
  %12 = fadd <2 x double> %8, %11, !dbg !56
...
!1 = !DIFile(filename: "../../SPEC_CPU2006v1.1/benchspec/CPU2006/433.milc/src/s_m_a_mat.c", directory: "/Users/vaspol/Documents/classes/EECS583/ClassProject/source_extraction_scripts")
!2 = !{}
!3 = !{!4}
!4 = !DISubprogram(name: "scalar_mult_add_su3_matrix", scope: !1, file: !1, line: 12, type: !5, isLocal: false, isDefinition: true, scopeLine: 13, flags: DIFlagPrototyped, isOptimized: true, function: void (%struct.su3_matrix*, %struct.su3_matrix*, double, %struct.su3_matrix*)* @scalar_mult_add_su3_matrix, variables: !23)
