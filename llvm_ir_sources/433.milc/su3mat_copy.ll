; ModuleID = '../../SPEC/benchspec/CPU2006/433.milc/src/su3mat_copy.c'
...
for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  ...
  %real = getelementptr inbounds %struct.su3_matrix* %a, i64 0, i32 0, i64 %indvars.iv40, i64 %indvars.iv, i32 0, !dbg !35
  %0 = load double* %real, align 8, !dbg !35, !tbaa !37
  %real11 = getelementptr inbounds %struct.su3_matrix* %b, i64 0, i32 0, i64 %indvars.iv40, i64 %indvars.iv, i32 0, !dbg !35
  store double %0, double* %real11, align 8, !dbg !35, !tbaa !37
  %imag = getelementptr inbounds %struct.su3_matrix* %a, i64 0, i32 0, i64 %indvars.iv40, i64 %indvars.iv, i32 1, !dbg !40
  %1 = load double* %imag, align 8, !dbg !40, !tbaa !37
  %imag22 = getelementptr inbounds %struct.su3_matrix* %b, i64 0, i32 0, i64 %indvars.iv40, i64 %indvars.iv, i32 1, !dbg !40
  store double %1, double* %imag22, align 8, !dbg !40, !tbaa !37
...
for.inc23:                                        ; preds = %for.body3
  %indvars.iv.next41 = add i64 %indvars.iv40, 1, !dbg !31
  %lftr.wideiv42 = trunc i64 %indvars.iv.next41 to i32, !dbg !31
  %exitcond43 = icmp eq i32 %lftr.wideiv42, 3, !dbg !31
  br i1 %exitcond43, label %for.end25, label %for.cond1.preheader, !dbg !31
...
!0 = metadata !{i32 786449, metadata !1, i32 12, metadata !"clang version 3.3 (tags/RELEASE_33/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/433.milc/src/su3mat_copy.c] [DW_LANG_C99]
!1 = metadata !{metadata !"../../SPEC/benchspec/CPU2006/433.milc/src/su3mat_copy.c", metadata !"/home/arquinn/Project1/EECS583/source_extraction_scripts"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"su3mat_copy", metadata !"su3mat_copy", metadata !"", i32 11, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, void (%struct.su3_matrix*, %struct.su3_matrix*)* @su3mat_copy, null, null, metadata !24, i32 11} ; [ DW_TAG_subprogram ] [line 11] [def] [su3mat_copy]
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/433.milc/src/su3mat_copy.c]
...
!32 = metadata !{i32 786443, metadata !1, metadata !4, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/433.milc/src/su3mat_copy.c]
!33 = metadata !{i32 13, i32 0, metadata !34, null}
!34 = metadata !{i32 786443, metadata !1, metadata !32, i32 13, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/433.milc/src/su3mat_copy.c]
!35 = metadata !{i32 14, i32 0, metadata !36, null}
!36 = metadata !{i32 786443, metadata !1, metadata !34, i32 13, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/433.milc/src/su3mat_copy.c]
!37 = metadata !{metadata !"double", metadata !38}
!38 = metadata !{metadata !"omnipotent char", metadata !39}
!39 = metadata !{metadata !"Simple C/C++ TBAA"}
!40 = metadata !{i32 15, i32 0, metadata !36, null}
