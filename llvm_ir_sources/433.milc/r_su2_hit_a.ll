; ModuleID = '../../SPEC_CPU2006v1.1/benchspec/CPU2006/433.milc/src/r_su2_hit_a.c'
...
; <label>:3                                       ; preds = %3, %0
  ...
  %4 = getelementptr inbounds %struct.su3_matrix* %link, i64 0, i32 0, i64 %indvars.iv, i64 %1, !dbg !48
  %5 = getelementptr inbounds %struct.su3_matrix* %link, i64 0, i32 0, i64 %indvars.iv, i64 %2, !dbg !51
  tail call void @mult_su2_mat_vec_elem_a(%struct.su2_matrix* %u, %struct.complex* %4, %struct.complex* %5) #3, !dbg !53
...
!1 = !DIFile(filename: "../../SPEC_CPU2006v1.1/benchspec/CPU2006/433.milc/src/r_su2_hit_a.c", directory: "/Users/vaspol/Documents/classes/EECS583/ClassProject/source_extraction_scripts")
!2 = !{}
!3 = !{!4}
!4 = !DISubprogram(name: "right_su2_hit_a", scope: !1, file: !1, line: 10, type: !5, isLocal: false, isDefinition: true, scopeLine: 11, flags: DIFlagPrototyped, isOptimized: true, function: void (%struct.su2_matrix*, i32, i32, %struct.su3_matrix*)* @right_su2_hit_a, variables: !32)
...
!42 = !DIExpression()
!43 = !DILocation(line: 10, column: 34, scope: !4)
!44 = !DILocation(line: 10, column: 40, scope: !4)
!45 = !DILocation(line: 10, column: 46, scope: !4)
!46 = !DILocation(line: 10, column: 60, scope: !4)
