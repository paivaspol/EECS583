; ModuleID = '../../SPEC_CPU2006v1.1/benchspec/CPU2006/433.milc/src/m_mat_na.c'
...
; <label>:1                                       ; preds = %1, %.preheader
  ...
  %4 = getelementptr inbounds %struct.su3_matrix* %b, i64 0, i32 0, i64 %indvars.iv8, i64 %indvars.iv, i32 0, !dbg !53
  %5 = load double* %4, align 8, !dbg !53, !tbaa !57
  %6 = bitcast double* %3 to <2 x double>*, !dbg !53
  %7 = load <2 x double>* %6, align 8, !dbg !53, !tbaa !62
  %8 = getelementptr inbounds %struct.su3_matrix* %b, i64 0, i32 0, i64 %indvars.iv8, i64 %indvars.iv, i32 1, !dbg !53
  ...
  %10 = insertelement <2 x double> undef, double %5, i32 0, !dbg !53
  %11 = insertelement <2 x double> %10, double %5, i32 1, !dbg !53
  %12 = fmul <2 x double> %7, %11, !dbg !53
  %13 = shufflevector <2 x double> %7, <2 x double> undef, <2 x i32> <i32 1, i32 0>, !dbg !53
  %14 = insertelement <2 x double> undef, double %9, i32 0, !dbg !53
  %15 = insertelement <2 x double> %14, double %9, i32 1, !dbg !53
  %16 = fmul <2 x double> %13, %15, !dbg !53
...
!1 = !DIFile(filename: "../../SPEC_CPU2006v1.1/benchspec/CPU2006/433.milc/src/m_mat_na.c", directory: "/Users/vaspol/Documents/classes/EECS583/ClassProject/source_extraction_scripts")
!2 = !{}
!3 = !{!4}
!4 = !DISubprogram(name: "mult_su3_na", scope: !1, file: !1, line: 12, type: !5, isLocal: false, isDefinition: true, scopeLine: 12, flags: DIFlagPrototyped, isOptimized: true, function: void (%struct.su3_matrix*, %struct.su3_matrix*, %struct.su3_matrix*)* @mult_su3_na, variables: !23)
...
!37 = !DIExpression()
!38 = !DILocation(line: 12, column: 32, scope: !4)
!39 = !DILocation(line: 12, column: 47, scope: !4)
!40 = !DILocation(line: 12, column: 62, scope: !4)
