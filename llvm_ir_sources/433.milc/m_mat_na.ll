...
for.body6:                                        ; preds = %for.body6, %for.cond4.preheader
  ...
  %real15 = getelementptr inbounds %struct.su3_matrix* %b, i64 0, i32 0, i64 %indvars.iv107, i64 %indvars.iv, i32 0
  ...
  %imag27 = getelementptr inbounds %struct.su3_matrix* %b, i64 0, i32 0, i64 %indvars.iv107, i64 %indvars.iv, i32 1
  ...
  %add59 = fadd double %x.sroa.0.0104, %add
  %add62 = fadd double %x.sroa.1.0103, %sub
