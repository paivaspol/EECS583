; ModuleID = '../../SPEC_CPU2006v1.1/benchspec/CPU2006/433.milc/src/m_mat_hwvec.c'
...
define void @mult_su3_mat_hwvec(%struct.su3_matrix* %mat, %struct.half_wilson_vector* %src, %struct.half_wilson_vector* %dest) #0 {
  ...
  tail call void @mult_su3_mat_vec(%struct.su3_matrix* %mat, %struct.su3_vector* %1, %struct.su3_vector* %2) #3, !dbg !51
  ...
  tail call void @mult_su3_mat_vec(%struct.su3_matrix* %mat, %struct.su3_vector* %3, %struct.su3_vector* %4) #3, !dbg !54
  ret void, !dbg !55
}
...
!1 = !DIFile(filename: "../../SPEC_CPU2006v1.1/benchspec/CPU2006/433.milc/src/m_mat_hwvec.c", directory: "/Users/vaspol/Documents/classes/EECS583/ClassProject/source_extraction_scripts")
!2 = !{}
!3 = !{!4}
!4 = !DISubprogram(name: "mult_su3_mat_hwvec", scope: !1, file: !1, line: 14, type: !5, isLocal: false, isDefinition: true, scopeLine: 15, flags: DIFlagPrototyped, isOptimized: true, function: void (%struct.su3_matrix*, %struct.half_wilson_vector*, %struct.half_wilson_vector*)* @mult_su3_mat_hwvec, variables: !37)
...
!37 = !{!38, !39, !40}
!38 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "mat", arg: 1, scope: !4, file: !1, line: 14, type: !7)
!39 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "src", arg: 2, scope: !4, file: !1, line: 14, type: !23)
!40 = !DILocalVariable(tag: DW_TAG_arg_variable, name: "dest", arg: 3, scope: !4, file: !1, line: 15, type: !23)
...
!45 = !DIExpression()
!46 = !DILocation(line: 14, column: 38, scope: !4)
!47 = !DILocation(line: 14, column: 63, scope: !4)
!48 = !DILocation(line: 15, column: 22, scope: !4)
!49 = !DILocation(line: 16, column: 29, scope: !4)
!50 = !DILocation(line: 16, column: 43, scope: !4)
!51 = !DILocation(line: 16, column: 5, scope: !4)
!52 = !DILocation(line: 17, column: 29, scope: !4)
!53 = !DILocation(line: 17, column: 43, scope: !4)
!54 = !DILocation(line: 17, column: 5, scope: !4)
!55 = !DILocation(line: 18, column: 1, scope: !4)
