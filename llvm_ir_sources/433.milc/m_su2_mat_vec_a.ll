; ModuleID = '../../SPEC_CPU2006v1.1/benchspec/CPU2006/433.milc/src/m_su2_mat_vec_a.c'
...
define void @mult_su2_mat_vec_elem_a(%struct.su2_matrix* nocapture readonly %u, %struct.complex* nocapture %x0, %struct.complex* nocapture %x1) #0 {
  ...
  %16 = fadd <2 x double> %11, %15, !dbg !48
  %17 = fsub <2 x double> %11, %15, !dbg !48
  ...
  %30 = fadd <2 x double> %25, %29, !dbg !56
  %31 = fsub <2 x double> %25, %29, !dbg !56
  ...
  %45 = fadd <2 x double> %41, %44, !dbg !61
  %46 = fsub <2 x double> %41, %44, !dbg !61
  ...
  %58 = fadd <2 x double> %54, %57, !dbg !63
  %59 = fsub <2 x double> %54, %57, !dbg !63
...
!1 = !DIFile(filename: "../../SPEC_CPU2006v1.1/benchspec/CPU2006/433.milc/src/m_su2_mat_vec_a.c", directory: "/Users/vaspol/Documents/classes/EECS583/ClassProject/source_extraction_scripts")
!2 = !{}
!3 = !{!4}
!4 = !DISubprogram(name: "mult_su2_mat_vec_elem_a", scope: !1, file: !1, line: 10, type: !5, isLocal: false, isDefinition: true, scopeLine: 11, flags: DIFlagPrototyped, isOptimized: true, function: void (%struct.su2_matrix*, %struct.complex*, %struct.complex*)* @mult_su2_mat_vec_elem_a, variables: !24)
