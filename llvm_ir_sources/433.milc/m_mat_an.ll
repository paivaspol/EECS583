; ModuleID = '../../SPEC_CPU2006v1.1/benchspec/CPU2006/433.milc/src/m_mat_an.c'
...
define void @mult_su3_an(%struct.su3_matrix* nocapture readonly %a, %struct.su3_matrix* nocapture readonly %b, %struct.su3_matrix* nocapture %c) #0 {
...
; <label>:1                                       ; preds = %1, %.preheader
  ...
  %3 = getelementptr inbounds %struct.su3_matrix* %a, i64 0, i32 0, i64 %indvars.iv, i64 %indvars.iv11, i32 0, !dbg !53
  %4 = load double* %3, align 8, !dbg !53, !tbaa !57
  %5 = getelementptr inbounds %struct.su3_matrix* %b, i64 0, i32 0, i64 %indvars.iv, i64 %indvars.iv8, i32 0, !dbg !53
  %6 = getelementptr inbounds %struct.su3_matrix* %a, i64 0, i32 0, i64 %indvars.iv, i64 %indvars.iv11, i32 1, !dbg !53
  %7 = load double* %6, align 8, !dbg !53, !tbaa !62
  %8 = bitcast double* %5 to <2 x double>*, !dbg !53
  %9 = load <2 x double>* %8, align 8, !dbg !53, !tbaa !63
  tail call void @llvm.dbg.value(metadata double undef, i64 0, metadata !32, metadata !64), !dbg !42
  %10 = insertelement <2 x double> undef, double %4, i32 0, !dbg !53
  %11 = insertelement <2 x double> %10, double %4, i32 1, !dbg !53
  %12 = fmul <2 x double> %11, %9, !dbg !53
  %13 = insertelement <2 x double> undef, double %7, i32 0, !dbg !53
  %14 = insertelement <2 x double> %13, double %7, i32 1, !dbg !53
  %15 = shufflevector <2 x double> %9, <2 x double> undef, <2 x i32> <i32 1, i32 0>, !dbg !53
  %16 = fmul <2 x double> %14, %15, !dbg !53
  %17 = fadd <2 x double> %12, %16, !dbg !53
  %18 = fsub <2 x double> %12, %16, !dbg !53
...
!1 = !DIFile(filename: "../../SPEC_CPU2006v1.1/benchspec/CPU2006/433.milc/src/m_mat_an.c", directory: "/Users/vaspol/Documents/classes/EECS583/ClassProject/source_extraction_scripts")
!2 = !{}
!3 = !{!4}
!4 = !DISubprogram(name: "mult_su3_an", scope: !1, file: !1, line: 12, type: !5, isLocal: false, isDefinition: true, scopeLine: 12, flags: DIFlagPrototyped, isOptimized: true, function: void (%struct.su3_matrix*, %struct.su3_matrix*, %struct.su3_matrix*)* @mult_su3_an, variables: !23)
