...
entry:
  ...
  %real = getelementptr inbounds %struct.su2_matrix* %u, i64 0, i32 0, i64 0, i64 0, i32 0, !dbg !37
  %0 = load double* %real, align 8, !dbg !37, !tbaa !39
  %mul = fmul double %t0.sroa.0.0.copyload, %0, !dbg !37
  %imag = getelementptr inbounds %struct.su2_matrix* %u, i64 0, i32 0, i64 0, i64 0, i32 1, !dbg !37
  %1 = load double* %imag, align 8, !dbg !37, !tbaa !39
  %mul7 = fmul double %t0.sroa.1.8.copyload, %1, !dbg !37
  %sub = fsub double %mul, %mul7, !dbg !37
  %mul14 = fmul double %t0.sroa.1.8.copyload, %0, !dbg !37
  %mul20 = fmul double %t0.sroa.0.0.copyload, %1, !dbg !37
  %add = fadd double %mul14, %mul20, !dbg !37
  %real25 = getelementptr inbounds %struct.su2_matrix* %u, i64 0, i32 0, i64 0, i64 1, i32 0, !dbg !42
  %2 = load double* %real25, align 8, !dbg !42, !tbaa !39
  %mul27 = fmul double %t1.sroa.0.0.copyload, %2, !dbg !42
  %imag31 = getelementptr inbounds %struct.su2_matrix* %u, i64 0, i32 0, i64 0, i64 1, i32 1, !dbg !42
  %3 = load double* %imag31, align 8, !dbg !42, !tbaa !39
  %mul33 = fmul double %t1.sroa.1.8.copyload, %3, !dbg !42
  %sub34 = fsub double %mul27, %mul33, !dbg !42
  %mul41 = fmul double %t1.sroa.1.8.copyload, %2, !dbg !42
  %mul47 = fmul double %t1.sroa.0.0.copyload, %3, !dbg !42
  %add48 = fadd double %mul41, %mul47, !dbg !42
  %add52 = fadd double %sub, %sub34, !dbg !44
  store double %add52, double* %t0.sroa.0.0.idx, align 8, !dbg !44, !tbaa !39
  %add56 = fadd double %add, %add48, !dbg !44
  store double %add56, double* %t0.sroa.1.8.idx132, align 8, !dbg !44, !tbaa !39
  %real61 = getelementptr inbounds %struct.su2_matrix* %u, i64 0, i32 0, i64 1, i64 0, i32 0, !dbg !46
  %4 = load double* %real61, align 8, !dbg !46, !tbaa !39
  %mul63 = fmul double %t0.sroa.0.0.copyload, %4, !dbg !46
  %imag67 = getelementptr inbounds %struct.su2_matrix* %u, i64 0, i32 0, i64 1, i64 0, i32 1, !dbg !46
  %5 = load double* %imag67, align 8, !dbg !46, !tbaa !39
  %mul69 = fmul double %t0.sroa.1.8.copyload, %5, !dbg !46
  %sub70 = fsub double %mul63, %mul69, !dbg !46
  %mul77 = fmul double %t0.sroa.1.8.copyload, %4, !dbg !46
  %mul83 = fmul double %t0.sroa.0.0.copyload, %5, !dbg !46
  %add84 = fadd double %mul77, %mul83, !dbg !46
  %real89 = getelementptr inbounds %struct.su2_matrix* %u, i64 0, i32 0, i64 1, i64 1, i32 0, !dbg !48
  %6 = load double* %real89, align 8, !dbg !48, !tbaa !39
  %mul91 = fmul double %t1.sroa.0.0.copyload, %6, !dbg !48
  %imag95 = getelementptr inbounds %struct.su2_matrix* %u, i64 0, i32 0, i64 1, i64 1, i32 1, !dbg !48
  %7 = load double* %imag95, align 8, !dbg !48, !tbaa !39
  %mul97 = fmul double %t1.sroa.1.8.copyload, %7, !dbg !48
  %sub98 = fsub double %mul91, %mul97, !dbg !48
  %mul105 = fmul double %t1.sroa.1.8.copyload, %6, !dbg !48
  %mul111 = fmul double %t1.sroa.0.0.copyload, %7, !dbg !48
  %add112 = fadd double %mul105, %mul111, !dbg !48
  %add116 = fadd double %sub70, %sub98, !dbg !50
  store double %add116, double* %t1.sroa.0.0.idx, align 8, !dbg !50, !tbaa !39
  %add120 = fadd double %add84, %add112, !dbg !50
...
!0 = metadata !{i32 786449, metadata !1, i32 12, metadata !"clang version 3.3 (tags/RELEASE_33/final)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/433.milc/src/m_su2_mat_vec_n.c] [DW_LANG_C99]
!1 = metadata !{metadata !"../../SPEC/benchspec/CPU2006/433.milc/src/m_su2_mat_vec_n.c", metadata !"/home/arquinn/Project1/EECS583/source_extraction_scripts"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"mult_su2_mat_vec_elem_n", metadata !"mult_su2_mat_vec_elem_n", metadata !"", i32 10, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 true, void (%struct.su2_matrix*, %struct.complex*, %struct.complex*)* @mult_su2_mat_vec_elem_n, null, null, metadata !25, i32 11} ; [ DW_TAG_subprogram ] [line 10] [def] [scope 11] [mult_su2_mat_vec_elem_n]
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/433.milc/src/m_su2_mat_vec_n.c]
...
!38 = metadata !{i32 786443, metadata !1, metadata !4, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/433.milc/src/m_su2_mat_vec_n.c]
...
!43 = metadata !{i32 786443, metadata !1, metadata !4, i32 22, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/433.milc/src/m_su2_mat_vec_n.c]
!44 = metadata !{i32 23, i32 0, metadata !45, null}
!45 = metadata !{i32 786443, metadata !1, metadata !4, i32 23, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/433.milc/src/m_su2_mat_vec_n.c]
!46 = metadata !{i32 24, i32 0, metadata !47, null}
!47 = metadata !{i32 786443, metadata !1, metadata !4, i32 24, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/433.milc/src/m_su2_mat_vec_n.c]
!48 = metadata !{i32 25, i32 0, metadata !49, null}
!49 = metadata !{i32 786443, metadata !1, metadata !4, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/433.milc/src/m_su2_mat_vec_n.c]
!50 = metadata !{i32 26, i32 0, metadata !51, null}
!51 = metadata !{i32 786443, metadata !1, metadata !4, i32 26, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/arquinn/Project1/EECS583/source_extraction_scripts/../../SPEC/benchspec/CPU2006/433.milc/src/m_su2_mat_vec_n.c]
