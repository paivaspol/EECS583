; ModuleID = '../../SPEC/benchspec/CPU2006/400.perlbench/src/Hostname.c'
...
@.str1 = private unnamed_addr constant [58 x i8] c"../../SPEC/benchspec/CPU2006/400.perlbench/src/Hostname.c\00", align 1
@.str2 = private unnamed_addr constant [22 x i8] c"Sys::Hostname::ghname\00", align 1
@PL_sv_yes = external global %struct.sv

; Function Attrs: nounwind optsize uwtable
define void @XS_Sys__Hostname_ghname(%struct.cv* nocapture %cv) #0 {
entry:
...
if.end:                                           ; preds = %entry, %if.then
  ...
  %sub.ptr.lhs.cast9 = ptrtoint %struct.sv** %5 to i64
  %sub.ptr.rhs.cast10 = ptrtoint %struct.sv** %add.ptr8 to i64
  %sub.ptr.sub11 = sub i64 %sub.ptr.lhs.cast9, %sub.ptr.rhs.cast10
  %cmp13 = icmp slt i64 %sub.ptr.sub11, 8
  br i1 %cmp13, label %if.then15, label %if.then19

if.then15:                                        ; preds = %if.end
  %call = tail call %struct.sv** @Perl_stack_grow(%struct.sv** %add.ptr8, %struct.sv** %add.ptr8, i32 1) #2
  br label %if.then19

if.then19:                                        ; preds = %if.end, %if.then15
  %sext38 = add i64 %add.ptr.idx, 4294967296
  %idxprom = ashr exact i64 %sext38, 32
  ...
  %add.ptr22 = getelementptr inbounds %struct.sv** %7, i64 %idxprom
...
; Function Attrs: nounwind optsize uwtable
define void @boot_Sys__Hostname(%struct.cv* nocapture %cv) #0 {
entry:
  ...
  %call = tail call %struct.cv* @Perl_newXS(i8* getelementptr inbounds ([22 x i8]* @.str2, i64 0, i64 0), void (%struct.cv*)* @XS_Sys__Hostname_ghname, i8* getelementptr inbounds ([58 x i8]* @.str1, i64 0, i64 0)) #2
